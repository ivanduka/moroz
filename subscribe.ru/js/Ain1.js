...
$(document).ready(function () {
  ...
  $(".js_keydown_selector").live("keyup", function (event) {
    //отслеживаем нажатие 'enter' или 'esc' на форме
    if (event.keyCode == 13) {
      //нажали ентер
...
function parse_result(res, farg) {
  ...
  if (mf == 1) {
    ...
    if (msg_id == "reg_msg") {
      ...
      if (typeof aobj != "undefined") {
        // выполняем отложенное авторизацией действие
    ...
    // авторизация или регистрация прошли НЕ успешно
...
// vajen: п©я─пЎп╡п╣я─п╨п╟ п©пЎп╩п╣п╧ я└пЎя─п╪я▀ group/create

// vajen: пЇп╟п╪п╣пҐп╟ пҐп╣п©п╣я┤п╟я┌п╟п╣п╪я▀я┘ пЄп╣я│я▐я┌п╦я┤пҐя▀я┘ html-п╨пЎпЄпЎп╡ пҐп╟ hex(пҐп╟я├. п╟п╩я└п╟п╡п╦я┌я▀) (я│я┌я─п╟пҐп╦я├я▀ я─п╟я│я│я▀п╩пЎп╨)
...
// я┤я┌пЎ пЄп╣п╩п╟я┌я▄ п©пЎя│п╩п╣ п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╦
var subscriberu = {
...
$.blockUI.defaults.css = {}; // я│п╠я─пЎя│ пҐп╟я│я┌я─пЎп╣п╨ css пЄп╩я▐ п╠п╩пЎп╨п╦я─п╟я┌пЎя─п╟
...
var userinfo = {
  ...
  aobj: null,
  extquick: 0,
  confirmed: 0, // п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐпҐя▀п╧ п╟п╨п╨п╟я┐пҐя┌
  recommendation: 0, // я─п╣п╨пЎп╪п╣пҐпЄп╟я├п╦я▐ я─п╟я│я│я▀п╩пЎп╨ п╦ пЄп╟п╧пЄпІп╣я│я┌пЎп╡
  eq: {
    redirect: "",
    email: "",
    grp: "",
...
var aobj; // пЎп╠я┼п╣п╨я┌ п╡я▀п╠я─п╟пҐпҐпЎп╧ я│я│я▀п╩п╨п╦ (пЄп╩я▐ п©пЎя│п╩п╣пЄя┐я▌я┴п╦я┘ пЄп╣п╧я│я┌п╡п╦п╧ (п©пЎпЄп©п╦я│п╨п╟, п╡я│я┌я┐п©п╩п╣пҐп╦п╣ п╡ пЁя─я┐п©п©я┐, etc))

var ui = { pbimg: '<img src="/img/progressbar.gif" width=32 heigth=32/>' };

var ajax_url = {
  auth: "/MEMBERLOGIN_authen_cred", //п╟п╡я┌пЎя─п╦пЇп╟я├п╦я▐
  reg: "/member/join", //я─п╣пЁп╦я│я┌я─п╟я├п╦я▐
  recall: "/member/info", //пҐп╟п©пЎп╪п╦пҐп╟пҐп╦п╣ п©п╟я─пЎп╩я▐
  subscribe: "/member", // п©пЎпЄп©п╦я│п╨п╟
  love: "/member/love", // п╡ п╦пЇп╠я─п╟пҐпҐпЎп╣ (п╡ пЄя─я┐пЇя▄я▐)
  quick: "/member/quick", // п╠я▀я│я┌я─п╟я▐ п©пЎпЄп©п╦я│п╨п╟
  update: "/member/sub", // п╟пҐп╨п╣я┌п╟
  profile: "/member/profile", // п©я─пЎя└п╦п╩я▄ п©пЎпЄп©п╦я│я┤п╦п╨п╟
  confirm: "/member/confirm", // п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦п╣ п╟п╨п╨п╟я┐пҐя┌п╟
};
...
function eventstat(e) {
  ...
  var i = $("<img></img>").hide().appendTo("body"); // я│пЎпЇпЄп╟п╣п╪ я│п╨я─я▀я┌я▀п╧ я█п╩п╣п╪п╣пҐя┌
  i.attr("id", "esi"); // п╦пЄп╣пҐя┌п╦я└п╦я├п╦я─я┐п╣п╪
  i.attr("src", src); // пЇп╟пЁя─я┐пІп╟п╣п╪
  i.remove();
}

// п╡я▀п©пЎп╩пҐя▐п╣я┌ пЎя┌п╩пЎпІп╣пҐпҐпЎп╣ (п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╣п╧ пҐп╟ пЄя─я┐пЁпЎп╪ я│п╟п╧я┌п╣) пЄп╣п╧я│я┌п╡п╦п╣
function dosuspended() {
  if (typeof $.cookie == "function") {
    // п╣я│я┌я▄ п╨я┐п╨п╦
    var suspended = $.cookie("Felissuspended"); // пЎя┌п╩пЎпІп╣пҐпҐпЎп╣ пЄп╣п╧я│я┌п╡п╦п╣
...
function quickFormOk() {
  ...
  //$('#trtypeauth').hide(); // я│п╨я─я▀п╡п╟п╣п╪ я─п╟пЄп╦пЎп╨пҐпЎп©п╨п╦ п╡я▀п╠пЎя─п╟ я┌п╦п©п╟ п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╦/я─п╣пЁп╦я│я┌я─п╟я├п╦п╦
}

// п╡я▀п╡пЎпЄ я└пЎя─п╪я▀ п©я─пЎп╡п╣я─п╨п╦ п╦ пЄпЎп╠п╟п╡п╩п╣пҐп╦я▐ пҐп╦п╨п╟
function shownickForm() {
  var blockmsg = "#nickForm";
  $("#nick_msg").html("");
  $("#nickFormBut").attr("disabled", ""); // п╡п╨п╩я▌я┤п╟п╣п╪ п╨пҐпЎп©п╨я┐
  $(".subscriberu_popup").hide(); // пЇп╟п╨я─я▀п╡п╟п╣п╪ п╡я│п╣ пЄя─я┐пЁп╦п╣ я└пЎя─п╪я▀
  $.blockUI.defaults.focusInput = true;
  $.blockUI({ message: $(blockmsg) });
  $(".blockOverlay")
    .attr("title", uimsg["unblock"])
...
/* GiN hands (go to login_register_form.js)
 // п╡я▀п╡пЎпЄ я└пЎя─п╪я▀ п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦я▐ п╟п╨п╨п╟я┐пҐя┌п╟
 function showconfirmForm(arg){
 defblockUI();
 var blockmsg = '#confirmForm';
 $('#needconfirmcode').attr('href', '/member/info?email=' + userinfo['email']);
 $('#confirm_email').text(userinfo['email']); // я┐я│я┌п╟пҐп╟п╡п╩п╦п╡п╟п╣п╪ п╟пЄя─п╣я│ п╡ я┌п╣п╨я│я┌
 $('.subscriberu_popup').hide(); // пЇп╟п╨я─я▀п╡п╟п╣п╪ п╡я│п╣ пЄя─я┐пЁп╦п╣ я└пЎя─п╪я▀
 $.blockUI.defaults.focusInput = true;
 $.blockUI({ message: $(blockmsg) });
 }
...
$("#needconfirmcode").live("click", function () {
  // п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦п╣ я─п╣пЁп╦я│я┌я─п╟я├п╦п╦
...
// п╡я▀п╡пЎпЄ я└пЎя─п╪я▀ п╟пҐп╨п╣я┌я▀
...
function showquickForm(arg) {
  ...
  $("#email_msg").text("");
  $("#qf_tapanel").show();
  $("#quickFormSubBut").attr("disabled", ""); // п╡п╨п╩я▌я┤п╟п╣п╪ п╨пҐпЎп©п╨я┐
  $("#subscriberu_email_pb").html(""); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ пЁя─п╟пЄя┐я│пҐп╦п╨
  if (!arg) {
    arg = {
  ...
  } // п╡я▀п╡пЎпЄп╦п╪ я█п╩п╣п╪п╣пҐя┌я▀ п©пЎ я┐п╪пЎп╩я┤п╟пҐп╦я▌
  if (
...
function hidebo() {
  ...
  var ccf = $("#confirm_code").length; // п©пЎп╩п╣ пЄп╩я▐ п╡п╡пЎпЄп╟ п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦я▐
  ...
  if (typeof aobj != "undefined") {
    if (aobj.attr("id") == "autoclick") {
      var d = document.domain.match(/subscribe\.ru/)
        ? document.domain
        : "subscribe.ru"; // п╡пЄя─я┐пЁ пЎя┌п╨я─я▀п╩п╦ п╦пЇ п╨п╣я┬п╟ - пЄпЎп╪п╣пҐ п÷п║
      var url = "http://" + d + "/group/"; // пЁп╩п╟п╡пҐп╟я▐ пЁя─я┐п©п©
      if (aobj.attr("href").match(/redirect_to\=\/group\/(.+?)\//)) {
        //url += RegExp.$1 + '/'; // п╨пЎя─пҐп╣п╡п╟я▐ п╨пЎпҐп╨я─п╣я┌пҐпЎп╧ пЁя─я┐п©п©я▀
        url += RegExp.$1; // п╨пЎя─пҐп╣п╡п╟я▐ п╨пЎпҐп╨я─п╣я┌пҐпЎп╧ пЁя─я┐п©п©я▀
  ...
  if (ccf) {
    // пҐп╟ я└пЎя─п╪п╣ п╠я▀п╩пЎ п©пЎп╩п╣ п╡п╡пЎпЄп╟ п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦я▐, п╦ п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄ - п╟п╡я┌пЎя─п╦пЇпЎп╡п╟пҐ
...
function h2q(h) {
  // п©я─п╣пЎп╠я─п╟пЇя┐п╣я┌ я┘п╣я┬ п╡ я│я┌я─пЎп╨я┐ п©п╟я─п╟п╪п╣я┌я─пЎп╡ (p1=v1&p2=v2&...&pN=vN)
  var res = [];
  var i = 0;
  $.each(h, function (key) {
    if (i > 0) res.push("&");
...
function pbshow(id) {
  var pb = $("#" + id);
  pb.html(ui["pbimg"]);
  pb.show(); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ п©я─пЎпЁя─п╣я│я│-п╠п╟я─
}
...
/* GiN hands
 ...
 pbshow('subscriberu_authform_pb'); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ п©я─пЎпЁя─п╣я│я│-п╠п╟я─
 $.ajax({
 'type' : 'POST',
 'url' :  ajax_url['quick'],
 'data' :  data,
 ...
 showquickForm(farg);
 $('#qf_tapanel').hide();
 $('#trpwd').show(); // п©пЎп╩п╣ пЄп╩я▐ п╡п╡пЎпЄп╟ п©п╟я─пЎп╩я▐
...
$(document).ready(function () {
  if (typeof $.cookie == "function") {
    // п╣я│я┌я▄ п╨я┐п╨п╦
    var vkcontent = $.cookie("FelisVKontakte"); // п©я─пЎп╡п╣я─я▐п╣п╪ - п©я─п╦я┬п╩п╦ я│ vk?
    $.cookie("FelisVKontakte", null, { path: "/" });
    var mrucontent = $.cookie("FelisMailRu"); // п©я─пЎп╡п╣я─я▐п╣п╪ - п©я─п╦я┬п╩п╦ я│ mailru?
    ...
    if (vkcontent != null && vkcontent != "") {
      ...
      if (vkcontent == "login") {
        ...
        showquickForm(); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ я└пЎя─п╪я┐ п╠я▀я│я┌я─пЎп╧ п©пЎпЄп©п╦я│п╨п╦
        quickFormOk(); // п╡я▀п╡пЎпЄп╦п╪ п╡ я│пЎп╨я─п╟я┴п╣пҐпҐпЎп╪ п╡п╦пЄп╣
  ...
  $("div.taitem").click(function (e) {
    ...
    if (
      ...
      if ($("#quickForm").is(":visible")) {
        // п╣я│п╩п╦ я█я┌пЎ я└пЎя─п╪п╟ п╠я▀я│я┌я─пЎп╧ п©пЎпЄп©п╦я│п╨п╦
        ...
        // я└пЎя─п╪п╟ п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╦
        ...
        // я└пЎя─п╪п╟ я─п╣пЁп╦я│я┌я─п╟я├п╦п╦
        if (ta == "email") {
          $(".trrf").show();
          $("#trrfid").hide();
        } else if (ta == "openid") {
  ...
  // я┐пЄп╟п╩п╣пҐп╦п╣ я┌п╣п╪я▀ п╡ пЁя─я┐п©п©п╣
  ...
  // п©я┐п╠п╩п╦п╨п╟я├п╦я▐ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦я▐ п╡ я┌п╣п╪п╣ пЁя─я┐п©п©я▀
  $("[id^=public_]").live("click", function (e) {
    ...
    var link = $(this).attr("href"),
      ...
      commid = comm.attr("id"),
      pub = $(this);
    //console.log('п·п©я┐п╠п╩п╦п╨пЎп╡п╟я┌я▄? '+link+' comm='+comm+' public='+pub);
    $.ajax({
      type: "POST",
      url: link,
      success: function (data) {
        ...
        var answer =
          ...
          '); return false;" rel="' +
          commid +
          '" class="com_reply">п·я┌п╡п╣я┌п╦я┌я▄</a>';
  ...
  // я┐пЄп╟п╩п╣пҐп╦п╣ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦я▐ п╡ я┌п╣п╪п╣ пЁя─я┐п©п©я▀
        ...
        callback: function () {
          ...
          if (allcomments) {
            comm
              .find(".content")
              .before(
                '<div class="del_note">п пЎп╪п╪п╣пҐя┌п╟я─п╦п╧ я┐пЄп╟п╩п╣пҐ, п╣пЁпЎ п╡п╦пЄя▐я┌ я┌пЎп╩я▄п╨пЎ п╪пЎпЄп╣я─п╟я┌пЎя─я▀ пЁя─я┐п©п©я▀ п╦ п╣пЁпЎ п╟п╡я┌пЎя─</div>'
              );
          } else {
            comm
              .find(".content")
              .prepend(
                "<div>п пЎп╪п╪п╣пҐя┌п╟я─п╦п╧ я┐пЄп╟п╩п╣пҐ, п╣пЁпЎ п╡п╦пЄя▐я┌ я┌пЎп╩я▄п╨пЎ п╪пЎпЄп╣я─п╟я┌пЎя─я▀ пЁя─я┐п©п©я▀ п╦ п╣пЁпЎ п╟п╡я┌пЎя─</div>"
              );
          }
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if (result["error"] == "error/delete/comments/norights") {
                alert(
                  "пё п╡п╟я│ пҐп╣ я┘п╡п╟я┌п╟п╣я┌ п©я─п╟п╡ пЄп╩я▐ я┐пЄп╟п╩п╣пҐп╦я▐ я█я┌пЎпЁпЎ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦я▐. п·п╠я─п╟я┌п╦я┌п╣я│я▄ п╨ п╟пЄп╪п╦пҐп╦я│я┌я─п╟я┌пЎя─я┐ пЁя─я┐п©п©я▀"
                );
  ...
  // я┐пЄп╟п╩п╣пҐп╦п╣ п╡я│п╣я┘ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦п╣п╡ п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▐ п╡ пЁя─я┐п©п©п╣
  ...
  // я│пЄп╣п╩п╟я┌я▄ я┌п╣п╪я┐ п╡п╟пІпҐпЎп╧
  ...
  // я┐пЄп╟п╩п╦я┌я▄ п╨пЎп╪п╪п╣пҐя┌п╟я─п�
// п©пЎп╨п╟пЇя▀п╡п╟п╣п╪, я┤я┌пЎ пЄп╣п╧я│я┌п╡п╦п╣ п╡я▀п©пЎп╩пҐп╣пҐпЎ
          obj.attr("disabled", "disabled"); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ п╨пҐпЎп©п╨я┐
          $.each(a, function (i) {
  ...
  // п╪пҐпЎпІп╣я│я┌п╡п╣пҐпҐя▀п╧ п╡я▀п╠пЎя─
  $(".subscriberu_ank_r").click(function () {
    ank_click($(this));
    return;
  });

  // п©пЎпЄп©п╦я│п╨п╟ пҐп╟ я─п╣п╨п╩п╟п╪пҐя▀п╣ п╪п╟я┌п╣я─п╦п╟п╩я▀ (optin)
  $(".subscriberu_ank_cb").click(function () {
    ank_click($(this));
    return;
  });

  // пЎп╠я─п╟п╠пЎя┌я┤п╦п╨ пҐп╟ пЄп╣п╧я│я┌п╡п╦п╣ п╟пҐп╨п╣я┌пҐя▀я┘ п©п╣я─п╣п╨п╩я▌я┤п╟я┌п╣п╩п╣п╧ п╦ я─п╟пЄп╦пЎп╨пҐпЎп©пЎп╨
      ...
      success: function (res) {
        ...
        if (res.match(/^member\/update\/done ank$/)) {
          if (obj.attr("type") == "radio") {
            // п╣я│п╩п╦ п╪пҐпЎпІп╣я│я┌п╡п╣пҐпҐя▀п╧ п╡я▀п╠пЎя─,
            var a = $(":radio[name=" + obj.attr("name") + "]");
            $.each(a, function (i) {
              a[i].disabled = true;
            }); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ п╡я│п╣ я█п╩п╣п╪п╣пҐя┌я▀
          } else {
            obj.attr("disabled", "disabled"); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ п╨пҐпЎп©п╨я┐
          }
          $("#l" + obj.attr("name")).css("color", "gray");
  ...
  // пЇп╟п╨я─я▀п╡п╟п╣п╪ п╠п╩пЎп╨ п╦ п©пЎпЇп╦я├п╦пЎпҐп╦я─я┐п╣п╪я│я▐ пҐп╟ я█п╩п╣п╪п╣пҐя┌п╣ я┐п©я─п╟п╡п╩п╣пҐп╦я▐,
  // vajen: я┐п╠п╦я─п╟п╣п╪ п╨п╩п╟я│я│ active  я┐ п╨пҐпЎп©п╨п╦
  function scroll2gear(id) {
    $("#fb" + id).hide();
    //var to = $('#sg' + id).offset().top; // п©пЎпЇп╦я├п╦пЎпҐп╦я─я┐п╣п╪я│я▐
  ...
  $(".cssbtn").click(function () {
    ...
    if (id.match(/^cssbtn(\d+?)$/)) {
      // пЇп╟п╨я─я▀п╡п╟п╣п╪ п╠п╩пЎп╨ я│ я└пЎя─п╪пЎп╧ п╡я▀п╠пЎя─пЎя┤пҐпЎп╧ п©пЎпЄп©п╦я│п╨п╦
      id = RegExp.$1;
      scroll2gear(id);
    }
  });

  // пЇп╟п©я─пЎя│ пҐп╟ п╡я▀п╠пЎя─пЎя┤пҐя┐я▌ п©пЎпЄп©п╦я│п╨я┐
  $(".ssbtn").click(function () {
    //if (userinfo.authorized==0){
    if ($(".subscriberu_unknown").length) {
      // п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄ пҐп╣ п╟п╡я┌пЎя─п╦пЇпЎп╡п╟пҐ
      aobj = $(this);
      //showquickForm();
      showloginForm();
      return;
    ...
    var data = res.join("&"); // я└пЎя─п╪п╦я─я┐п╣п╪ пЇп╟п©я─пЎя│
    var pb = $(this).parent("form").children("div.subscriberu_pb");
    pb.html(ui["pbimg"]); // п╡п╨п╩я▌я┤п╟п╣п╪ пЁя─п╟пЄя┐я│пҐп╦п╨
    pb.show();
    $.ajax({
      type: "POST",
─п╣пЁп╦я│я┌я─п╟я├п╦п╦
  ...
  $("#qFormSubBut").click(
    // я│пЎя┘я─п╟пҐп╣пҐп╦п╣ пЄп╟пҐпҐя▀я┘ п╟пҐп╨п╣я┌я▀
    function () {
      $(this).attr("disabled", "disabled"); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ п╨пҐпЎп©п╨я┐
      var res = [];
      var data;
      var a = [
        "ank16",
      ...
      pb.html(ui["pbimg"]); // п╡я▀п╡пЎпЄп╦п╪ п©я─пЎпЁя─п╣я│я│п╠п╟я─
      pb.show();
      if (userinfo["console"])
          ...
          if (res.match(/^member\/update\/done ank$/)) {
            if (userinfo["newreg"] == 1 || userinfo["extquick"] == 2) {
              ...
              if (userinfo["vk"]["event"] != "") {
                // п╣я│п╩п╦ п©я─п╦я┬п╩п╦ п╦пЇ п╨пЎпҐя┌п╟п╨я┌п╟
                return dosuspended();
              }
              if (userinfo["aobj"] != null) userinfo["aobj"].click(); // п╡я▀п©пЎп╩пҐя▐п╣п╪ пЎя┌п╩пЎпІп╣пҐпҐпЎп╣ пЄп╣п╧я│я┌п╡п╦п╣
            } else {
              userinfo["new"] = 1; // я└п╦п╨я│п╦я─я┐п╣п╪, я┤я┌пЎ п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄ пҐпЎп╡я▀п╧
              if (userinfo["confirmed"] != 1) {
                // п╣я│п╩п╦ п╣я┴п╣ пҐп╣ п©пЎпЄя┌п╡п╣я─пЄп╦п╩ я─п╣пЁп╦я│я┌я─п╟я├п╦я▌
                showquickForm(); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ я└пЎя─п╪я┐ п╠я▀я│я┌я─пЎп╧ п©пЎпЄп©п╦я│п╨п╦
                quickFormOk(); // п╡я▀п╡пЎпЄп╦п╪ п╡ я│пЎп╨я─п╟я┴п╣пҐпҐпЎп╪ п╡п╦пЄп╣
                show_msg("email_msg", uimsg["congradulation"], 1); // я│пЎпЎп╠я┴п╣пҐп╦п╣ пЎп╠ я┐я│п©п╣я┬пҐпЎп╧ я─п╣пЁп╦я│я┌я─п╟я├п╦п╦
              } else {
                hidebo(); // п©я─пЎя│я┌пЎ пЇп╟п╨я─я▀п╡п╟п╣п╪ пЎп╨пҐпЎ
              }
            }
          } else {
  ...
  // п╡я▀п╡пЎпЄ я└пЎя─п╪я▀ п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╦ я┌пЎп╩я▄п╨пЎ я│ п©п╟я─пЎп╩п╣п╪
  function showpwdform(arg) {
    userinfo["recommendation"] = 1;
    showloginForm(); // п╡п╡п╣я│я┌п╦ п©п╟я─пЎп╩я▄

    var cb = $(":checkbox[name=addgrp]");
    cb.attr("checked", ""); // п╡я▀п╨п╩я▌я┤п╟п╣п╪ п╡я│п╣ я└п╩п╟пІп╨п╦
    ...
    if (
      ...
      for (i = 0; i < cb.length; i++) {
        if (cb[i].value.match(pattern)) {
          cb[i].checked = true; // пЎя┌п╪п╣я┤п╟п╣п╪ я─п╣п╨пЎп╪п╣пҐпЄпЎп╡п╟пҐпҐя▀п╣ пЄп╟п╧пЄпІп╣я│я┌я▀ п╦ я─п╟я│я│я▀п╩п╨п╦
        }
      }
    }
    if (userinfo["console"]) console.log("cb length = " + cb.length);
    $("#tremail").hide(); // я│п╨я─я▀п╡п╟п╣п╪ п©пЎп╩п╣ email
    $("#trpwd").show(); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ п©пЎп╩п╣ п©п╟я─пЎп╩я▐
    $("#lf_tapanel").hide();
    $("#loginFormCpt").css("margin-left", "3em");
    $("#loginFormBut").val(subscriberu_but_cpt["subscribe"]);
    $("#credential_0").attr("value", arg["email"]); // я┐я│я┌п╟пҐп╟п╡п╩п╦п╡п╟п╣п╪ п╟пЄя─п╣я│ п╡ я│п╨я─я▀я┌пЎп╣ п©пЎп╩п╣
    changelinkrecall(1); // п╡п╨п╩я▌я┤п╟п╣п╪ я│я│я▀п╩п╨я┐ пҐп╟п©пЎп╪п╦пҐп╟пҐп╦я▐
    var msg = uimsg["quickadd"].replace("XXX", arg["email"]); // п©пЎпЄя│я┌п╟пҐпЎп╡п╨п╟ п╡ я│пЎпЎп╠я┴п╣пҐп╦п╣ email-п╟пЄя─п╣я│п╟
    show_msg("auth_msg", msg, 1); // п╡я▀п╡пЎпЄп╦п╪ я┌п╣п╨я│я┌ я│пЎ я│я│я▀п╩п╨пЎп╧ пҐп╟ пЎя┌п©я─п╟п╡п╨я┐ пЇп╟п©я─пЎя│п╟ п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦я▐
    ...
    $("#lftrtypeauth").hide(); // я│п╨я─я▀п╡п╟п╣п╪ п╡я▀п╠пЎя─ я│п©пЎя│пЎп╠п╟ п╟п╡я┌пЎя─п╦пЇп╟я├п╦п╦
    $(".linkconfirm").click(
      //пЇп╟п©я─пЎя│ пҐп╟ п©пЎп╩я┐я┤п╣пҐп╦п╣ п©п╦я│я▄п╪п╟ я│пЎ я│я│я▀п╩п╨пЎп╧ пЄп╩я▐ п©пЎпЄп©п╦я│п╨п╦
      function () {
        var h = arg;
        h["byemail"] = 1;
        var data = h2q(h);
  ...
  $("#confirmlaterFormBut").click(function () {
    // пЎя┌п╩пЎпІп╣пҐпҐя▀п╧ п╡п╡пЎпЄ п╨пЎпЄп╟ п©пЎпЄя┌п╡п╣я─пІпЄп╣пҐп╦я▐ - п©п╣я─п╣я┘пЎпЄ п╨ п╟пҐп╨п╣я┌п╣
    showqForm(); // п╟пҐп╨п╣я┌п╟
  });

  $("#quickFormSubBut").click(
    // п╠я▀я│я┌я─п╟я▐ п©пЎпЄп©п╦я│п╨п╟
    function () {
      ...
      if (ta == "openid") {
        ...
        if (
          ...
          return false;
        userinfo["quick"] = 1;
        var listgid; // п╨пЎпЄ я─п╟я│я│я▀п╩п╨п╦
        ...
        if (typeof aobj != "undefined") {
          if (aobj.hasClass("ssbtn")) {
            // п╡я▀п╠пЎя─пЎя┤пҐп╟я▐ п©пЎпЄп©п╦я│п╨п╟ --
            var h = {};
              ...
              $.ajax({
                ...
                success: function (res) {
                  ...
                  if (res.match(/^member\/quick\/(add|new)$/)) {
                    var what = RegExp.$1;
                    if (what == "add") {
                      // п╟пЄя─п╣я│ я┐пІп╣ п©пЎпЄп©п╦я│п╟пҐ, п©я─п╣пЄп╩п╟пЁп╟п╣п╪ п╡п╟я─п╦п╟пҐя┌я▀
                      showloginForm(); // п╡п╡п╣я│я┌п╦ п©п╟я─пЎп╩я▄
                      $("#lf_tapanel").hide();
                      $("#loginFormCpt").css("margin-left", "3em");
                      $("#loginFormBut").val(subscriberu_but_cpt["subscribe"]);
                      $("#credential_0").attr("value", $("#quickFormid").val());
                      $("#credential_0").click(); // п╡п╨п╩я▌я┤п╟п╣п╪ я│я│я▀п╩п╨я┐ пҐп╟п©пЎп╪п╦пҐп╟пҐп╦я▐
                    } else if (what == "new") {
                      eventstat("reg");
        ...
        if (userinfo["vk"]["event"].match(/^login|xz$/)) {
          ...
          if ($("#subscriberu_anksyncq").attr("checked") == true) {
            // п╡я▀п╠я─п╟пҐпЎ пЎп╠пҐпЎп╡п╩п╣пҐп╦п╣ п╟пҐп╨п╣я┌я▀ пЄп╟пҐпҐя▀п╪п╦ п╦пЇ vk
        ...
        if (userinfo["mru"]["event"].match(/^login|xz$/)) {
          ...
          if ($("#subscriberu_anksyncqmr").attr("checked") == true) {
            // п╡я▀п╠я─п╟пҐпЎ пЎп╠пҐпЎп╡п╩п╣пҐп╦п╣ п╟пҐп╨п╣я┌я▀ пЄп╟пҐпҐя▀п╪п╦ п╦пЇ Mail.ru
        ...
        $.ajax({
          ...
          success: function (r) {
            ...
            if (res.match(/^member\/quick\/(add|new)$/)) {
              ...
              if (what == "add") {
                // п╟пЄя─п╣я│ я┐пІп╣ п©пЎпЄп©п╦я│п╟пҐ, п©я─п╣пЄп╩п╟пЁп╟п╣п╪ п╡п╟я─п╦п╟пҐя┌я▀
                showpwdform(h); // я└пЎя─п╪п╟ пЄп╩я▐ п╡п╡пЎпЄп╟ п©п╟я─пЎп╩я▐
              } else if (what == "new") {
                eventstat("reg");
                userinfo["needconfirm"] == 1 ? showconfirmForm() : showqForm();
              }
            } else {
              // пҐп╟п©я─п╦п╪п╣я─, я┐пІп╣ п©пЎпЄп©п╦я│п╟пҐ - member\/quick\/already
  ...
  // пЎп╠я─п╟п╠пЎя┌я┤п╦п╨ пҐп╟п©пЎп╪п╦пҐп╟пҐп╦я▐ п©п╟я─пЎп╩я▐
  ...
  // п©я─пЎп╡п╣я─п╨п╟ п╦ (п╡ я│п╩я┐я┤п╟п╣ я┐я│п©п╣я┬пҐпЎпЁпЎ я─п╣пЇя┐п╩я▄я┌п╟я┌п╟) пЄпЎп╠п╟п╡п╩п╣пҐп╦п╣ пҐп╦п╨п╟ п╡ п©я─пЎя└п╦п╩я▄
  $("#nickFormBut").click(function (e) {
    if (e.button == 0 || !$(this).hasClass("subscriberu_nonick")) {
      // я┌пЎп╩я▄п╨пЎ пЄп╩я▐ п╩п╣п╡пЎп╧ п╨пҐпЎп©п╨п╦ п╪я▀я┬п╦
  ...
  $(".subscriberu_nonick").live("click", function () {
    // п©пЎп©я▀я┌п╨п╟ пЄпЎп╠п╟п╡п╦я┌я▄ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦п╧ п╦п╩п╦ пЎя┌п╨я─я▀я┌я▄ п©пЎя│я┌ п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩п╣п╪ я│ пҐп╣я┐п╨п╟пЇп╟пҐпҐя▀п╪ пҐп╦п╨пЎп╪
    aobj = $(this);
    shownickForm();
    return false;
  });
  ...
  $(".subscriberu_check_reg").live("click", function () {
    ...
    if (!i.hasClass("subscriberu_unknown")) {
      // п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄
    ...
    if (e.button == 0 || userinfo["authorized"] == 1) {
      ...
      if (i.hasClass("subscriberu_unknown")) {
        ...
        h["action"] = "update";
        if (sub_action) {
          //пЎя┌я┤п╣пЁпЎпІп╣ пЎя┌я┤п╣пЁпЎпІп╣ пЎя┌я┤п╣пЁпЎпІп╣ пҐп╣я┌я┐ я┐ пҐп╟я│ п©я─п╦пЇпҐп╟п╨п╟ я┤п╣ я│пЎп╠я│я┌п╡п╣пҐпҐпЎ пЄп╣п╩п╟п╣п╪?
          h[sub_action] = h["grp"];
        }
        var redirect = "";
        var reload = 0;
        ...
        $.ajax({
          // п╡я▀п©пЎп╩пҐя▐п╣п╪ пЇп╟п©я─пЎя│ пҐп╟ п©пЎпЄп©п╦я│п╨я┐
          type: "POST",
  ...
  // п©пЎпЄя│п╨п╟пЇп╨п╦ -пЄп╩я▐ я┌пЎп╩я▄п╨пЎ-я┤я┌пЎ п╡я│я┌я┐п©п╦п╡я┬п╣пЁпЎ п╡ пЁя─я┐п©п©я┐,
  ...
  // пЄпЎп╠п╟п╡п╩п╣пҐп╦п╣ пЎп╠я┼п╣п╨я┌п╟ п╡ п╦пЇп╠я─п╟пҐпЎп╣
    ...
    if (e.button == 0 || userinfo["authorized"] == 1) {
      ...
      if (!i.hasClass("subscriberu_unknown")) {
        ...
        if (href.match(/what=(.+?)\&type=(.+?)\&content=(.+?)$/)) {
          ...
          var reload = 0;
          if (userinfo["authorized"] == 1) {
            // п╣я│п╩п╦ п©пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄ п╟п╡я┌пЎя─п╦пЇпЎп╡п╟п╩я│я▐ п╦п╩п╦ пЇп╟я─п╣пЁп╦я│я┌я─п╦я─пЎп╡п╟п╩я│я▐
          ...
          // п©п╟я─п╟п╪п╣я┌я─я▀ пҐп╣ пЎп©я─п╣пЄп╣п╩п╣пҐя▀
        }
      } else {
        aobj = $(this);
        userinfo["quick"] = 0;
  ...
  // я│п╪п╣пҐп╟ п╦п╨пЎпҐп╨п╦ я│я│я▀п╩п╨п╦ пЄпЎп╠п╟п╡п╩п╣пҐп╦я▐ п╡ п╦пЇп╠я─п╟пҐпҐпЎп╣
  ...
  // я│п╪п╣пҐп╟ п╟пҐп╨пЎя─п╟ я│я│я▀п╩п╨п╦ п╦пЇ п╦пЇп╠я─п╟пҐпҐпЎпЁпЎ
  ...
  // я│п╪п╣пҐп╟ п╟пҐп╨пЎя─п╟ я│я│я▀п╩п╨п╦ п©пЎпЄп©п╦я│п╨п╦
  ...
  $("div.subscriberu_fbbox").live("mouseover", function () {
    /*
             ...
             if (obj.length){      // п©пЎпЇп╦я├п╦пЎпҐп╦я─пЎп╡п╟пҐп╦п╣ п╠п╩пЎп╨п╟ п╡пҐя┐я┌я─п╦ я│я┌я─п╟пҐп╦я├я▀, п©п╩я▐я│п╨п╦ я│ п╠я┐п╠пҐпЎп╪
             ...
             // п╟п╡я┌пЎя─я│п╨пЎп╣ пЎп╨пЎя┬п╨пЎ пЄп╩я▐ firefox, п╡пҐя┐я┌я─п╦ п╠п╩пЎп╨п╟ "div.act"
             ...
             } else { // пЎя│я┌п╟п╩я▄пҐпЎп╣ п╡я▀я─п╟п╡пҐп╦п╡п╟п╣п╪ п©пЎ п╡п╣я─я┌п╦п╨п╟п╩п╦
             if (ts < $(this).children('div:first').height() && t > ts){
             $(this).children('div:first').css("top", -$(this).children('div:first').height() + ts - gap);
             } else {
             ...
             // п©я─пЎп╡п╣я─п╨п╟ пҐп╟ пЎя┌п╨я─я▀я┌я▀п╣ п╠п╩пЎп╨п╦
  ...
  // пЎп╠я─п╟п╠пЎя┌п╨п╟ пЄпЎп╠п╟п╡п╩п╣пҐп╦я▐ пЎп╠я┼п╣п╨я┌п╟ п╡ п╦пЇп╠я─п╟пҐпҐпЎп╣
  function parse_love_res(data, farg) {
    ...
    if (res == 1) {
      ...
      i.removeClass("subscriberu_load"); // пЇп╟пЁя─я┐пЇп╨п╟ п╡я▀п©пЎп╩пҐп╣пҐп╟, п╡пЎпЇп╡я─п╟я┴п╟п╣п╪ я█п╩п╣п╪п╣пҐя┌я┐ пЎп╠я▀я┤пҐпЎп╣ п©пЎп╡п╣пЄп╣пҐп╦п╣
      ...
      // я┐я│я┌п╟пҐпЎп╡п╨п╟ п╟пҐп╨пЎя─пЎп╡
      if (data == "add") {
        if (v.html() != "") v.html(anchor["a"]); //п▓ п╦пЇп╠я─п╟пҐпҐпЎп╪
        i.addClass(aclass["a"]);
        i.removeClass(aclass["b"]);
        i.attr("href", i.attr("href").replace("=add", "=del"));
        i.css("color", "#ffffff");
      } else if (data == "del") {
        if (v.html() != "") v.html(anchor["b"]); //п▓ п╦пЇп╠я─п╟пҐпҐпЎп╣
        i.addClass(aclass["b"]);
      ...
      //alert('я─п╟пЇп╠пЎя─ пЎя┬п╦п╠п╨п╦');
    }
    doR(redirect, reload);
  }

  // пЎп╠я─п╟п╠пЎя┌п╨п╟ пЄпЎп╠п╟п╡п╩п╣пҐп╦я▐ п©пЎпЄп©п╦я│п╨п╦
    ...
    if (info[0] == "member/update/done") {
      ...
      if (info[1] == "sub") {
        ...
        if (lid.match(/^l(\d+?)$/)) {
          var fid = "#f" + RegExp.$1;
          if ($(fid).length) {
            // п╣я│п╩п╦ п╣я│я┌я▄ я└пЎя─п╪п╟, п╡я▀п╨п╩я▌я┤п╟п╣п╪ пЇпҐп╟я┤п╣пҐп╦я▐ п╡я▀п╠пЎя─пЎя┤пҐпЎп╧ п©пЎпЄп©п╦я│п╨п╦
  ...
  $(".subscriberu_category").each(function () {
    ...
    $(this)
      ...
      .click(function () {
        ...
        $(this).parents(".category").addClass("subscriberu_hidden"); // п╨п╟я┌п╣пЁпЎя─п╦я▐ я│п╨я─я▀я┌п╟

        var a = new Array();
        a = $("div.subscriberu_category:not(.subscriberu_hidden)"); // п╡я▀п╠п╦я─п╟п╣п╪ пҐп╣я│п╨я─я▀я┌я▀п╣ п╨п╟я┌п╣пЁпЎя─п╦п╦
        if (a.length == 0) $("#issue_menu").hide(); // п╣я│п╩п╦ я┌п╟п╨п╦я┘ пҐп╣я┌, я│п╨я─я▀п╡п╟п╣п╪ п╦ пЇп╟пЁпЎп╩пЎп╡пЎп╨
        ...
        if (cookie_check) {
          // п╨я┐п╨п╦ пҐп╣я┌, пЇпҐп╟я┤п╦я┌ п╦ п╨п╟я┌п╣пЁпЎя─п╦п╦ п╡ я│п©п╦я│п╨п╣ я│п╡п╣я─пҐя┐я┌я▀я┘ пҐп╣я┌
          ...
          $(".maximize ul")
            ...
            .click(function () {
              ...
              if (tmp == "") $(".maximize p.title").hide(); // п╣я│п╩п╦ п╡ п╨я┐п╨п╣ пҐп╣я┌ п╨п╟я┌п╣пЁпЎя─п╦п╧, я│п╨я─я▀п╡п╟п╣п╪ пЇп╟пЁпЎп╩пЎп╡пЎп╨ я│п©п╦я│п╨п╟
  ...
  // я└пЎя─п╪я─я┐п╣я┌ я│п©п╦я│пЎп╨ я│п╡п╣я─пҐя┐я┌я▀я┘ п╨п╟я┌п╣пЁпЎя─п╦п╧
  function rollupcatlist() {
    var cookie = $.cookie("Subscribe::Digest_foldedid"); // я│п╡п╣я─пҐя┐я┌я▀я┘ п╨п╟я┌п╣пЁпЎя─п╦п╧ п╡ п╨я┐п╨п╣ пҐп╣я┌
    if (cookie == "" || cookie == null) return false;
    $.cookie("Subscribe::Digest_foldedid", cookie, { expires: 7, path: "/" });
    $(".maximize p.title").show(); // п©пЎп╨п╟пЇя▀п╡п╟п╣п╪ пЇп╟пЁпЎп╩пЎп╡пЎп╨ я│п╡п╣я─пҐя┐я┌я▀я┘ п╨п╟я┌п╣пЁпЎя─п╦п╧
    cookie = cookie.split(/(?:\s)/);
    for (var i in cookie) {
      var item = $("#" + cookie[i]);
      ...
      $(".maximize ul")
        ...
        .click(
          function () {
            ...
            $("#content .category#" + cid).show();
            var to = $(".category#" + cid).offset().top;
            $("html,body").animate({ scrollTop: to }, "fast"); // п©пЎпЇп╦я├п╦пЎпҐп╦я─пЎп╡п╟пҐп╦п╣ п©пЎ id пҐп╟ пҐя┐пІпҐпЎп╧ я─я┐п╠я─п╦п╨п╣
  ...
  if (isindex) rollupcatlist(); // п╣я│п╩п╦ я│я┌я─п╟пҐп╦я├п╟ п╦пҐпЄп╣п╨я│пҐп╟я▐, п╡я▀п╡пЎпЄп╦п╪ я│п©п╦я│пЎп╨ п╨п╟я┌п╣пЁпЎя─п╦п╧
...
// п╡я▀п╡пЎпЄп╦я┌ я│пЎпЎп╠я┴п╣пҐп╦п╣
...
function group_unsubscribe_member(slug) {
  //пЎя┌п©п╦я│п╟я┌я│я▐ пЎя┌ пЁя─я┐п©п©я▀
...
function group_member_notify(obj) {
  //п╦пЇп╪п╣пҐп╦я┌я▄ я│п©пЎя│пЎп╠ я┐п╡п╣пЄпЎп╪п╩п╣пҐп╦я▐
...
/* old +/- for group topic
 ...
 voteD.css({'overflow':'hidden','height':'13px'}); // п÷пЎпЄпЁпЎя┌пЎп╡п╨п╟ п╨ я│п╨я─пЎп╩я┐
 ...
 voteD.animate({ 'overflow': 'visible', 'scrollTop': '0px' }); // пєп╦п╨я│ пЄп╩я▐ FF 3.0 - 4.0
 voteD.html(newVoteStr); // п≈п╟п╪п╣пҐп╟ html пҐп╟ пЎп╠я▀я┤пҐя▀п╧ я┌п╣п╨я│я┌
 });

 $('.ev-VoteUp, .ev-VoteDown').css('visibility','hidden');
 $.getJSON(url, {js: 1}); // п≈п╟п©я─пЎя│ пҐп╟ п╦пЇп╪п╣пҐп╣пҐп╦п╣ я│я┤п╣я┌я┤п╦п╨п╟
    ...
    if ($(".topicentry #usertext").length) {
      ...
      links.each(function () {
        ...
        if (link.search(regexpSub) < 0 && link.search(regexpHttp) > -1) {
          // нет слов subscribe.ru и есть http
...
$(document).ready(function () {
  ...
  $("#id_text.feedback_text-spam").DefaultValue(
    "п÷пЎя┤п╣п╪я┐ п╡я▀ я│я┤п╦я┌п╟п╣я┌п╣ я█я┌пЎ я│п©п╟п╪пЎп╪?"
  );
  $("#id_email.members_invite_emails").DefaultValue(
    "п╣я│п╩п╦ пҐп╣я│п╨пЎп╩я▄п╨пЎ, я┌пЎ я┤п╣я─п╣пЇ пЇп╟п©я▐я┌я┐я▌"
  );
  $(".nonregisteredpart #id_email").DefaultValue("@");
  $("#groupsearchq").DefaultValue("п÷пЎп╦я│п╨ п©пЎ пЁя─я┐п©п©п╣");
  checkboxActive();
});
...
function reinit_mce(self) {
  ...
  if (form_header.length) {
    $("span", form_header).html("п·я┌п╡п╣я┌ пҐп╟ п╨пЎп╪п╪п╣пҐя┌п╟я─п╦п╧");
...
function init_group_edit_behavior() {
    ...
    tinymce.init({
      ...
      setup: function (ed) {
        var wordscount = function () {
          ...
          ////п▓я│я┌п╟п╡п╨я┐ п╨пЎпЄп╟ (pre) - п╡я▀я─п╣пЇп╟п╣п╪///////////
  ...
  function loadCats(target, parent) {
    if (parent) {
      target.html(
        "<option value=''></option><option value=''>п≤пЄп╣я┌ пЇп╟пЁя─я┐пЇп╨п╟ пЄп╟пҐпҐя▀я┘...</option>"
      );
      $.getJSON(
        group_get_cats_url,
        {
  ...
  var cat0 = "",
    ...
    cat = {
      "Hi-Tech": "hitech",
      "п░п╡я┌пЎп╪пЎп╠п╦п╩п╦": "auto",
      "п▒п╦пЇпҐп╣я│ п╦ п╨п╟я─я▄п╣я─п╟": "business",
      "п■пЎп╪ п╦ я│п╣п╪я▄я▐": "home",
      "п пЎп╪п©я▄я▌я┌п╣я─я▀ п╦ п╦пҐя┌п╣я─пҐп╣я┌": "comp",
      "п я┐п╩я▄я┌я┐я─п╟, я│я┌п╦п╩я▄ пІп╦пЇпҐп╦": "culture",
      "п°п╦я─ пІп╣пҐя┴п╦пҐя▀": "woman",
      "п²пЎп╡пЎя│я┌п╦ п╦ п║п°п≤": "media",
      "п·п╠я┴п╣я│я┌п╡пЎ": "socio",
      "п÷я─пЎпЁпҐпЎпЇ п©пЎпЁпЎпЄя▀": "weather",
      "п║п©пЎя─я┌": "sport",
      "п║я┌я─п╟пҐя▀ п╦ я─п╣пЁп╦пЎпҐя▀": "country",
      "п╒я┐я─п╦пЇп╪": "travel",
      "пґп╨пЎпҐпЎп╪п╦п╨п╟ п╦ я└п╦пҐп╟пҐя│я▀": "economics",
    },
    hitech = {
      "п▓п╦пЄп╣пЎ п╦ пЇп╡я┐п╨": "hitech.video",
      "п⌠п╟пЄпІп╣я┌я▀": "hitech.gadj",
      "п пЎпҐя├п╣п©я┌я▀": "hitech.kon",
      "п²пЎп╡пЎя│я┌п╦": "hitech.news",
      "п║п╡я▐пЇя▄": "hitech.connection",
    },
    hitech_connection = {
      "п°пЎп╠п╦п╩я▄пҐп╟я▐ я│п╡я▐пЇя▄": "hitech.connection.mobile",
    },
    hitech_video,
    hitech_gadj,
    hitech_kon,
    hitech_news,
    auto = {
      "п░п╡я┌пЎп╠п╦пЇпҐп╣я│": "auto.biz",
      "п░п╡я┌пЎпҐпЎп╡пЎя│я┌п╦": "auto.worldnews",
      "п■пЎя─пЎпЁп╦": "auto.roads",
      "п²пЎп╡п╦пҐп╨п╦": "auto.newness",
      "п·п╠пЇпЎя─я▀": "auto.review",
      "п÷пЎп╩п╣пЇпҐя▀п╣ я│пЎп╡п╣я┌я▀": "auto.advice",
      "п║п°п≤ пЎп╠ п╟п╡я┌пЎп╪пЎп╠п╦п╩я▐я┘": "auto.smi",
      "п║п╦пЁпҐп╟п╩п╦пЇп╟я├п╦п╦": "auto.alarm",
      "п╒п╣я│я┌я▀": "auto.test",
      "п╒я▌пҐп╦пҐпЁ": "auto.tuning",
    },
    auto_biz,
    auto_worldnews,
    auto_roads,
    ...
    auto_tuning,
    business = {
      "п≈п╟п╨пЎпҐ": "business.law",
      "п пҐп╦пЁп╦ п╦ п÷п·": "business.book",
      "п°п╟я─п╨п╣я┌п╦пҐпЁ": "business.marketing",
      "п²п╣пЄп╡п╦пІп╦п╪пЎя│я┌я▄": "business.realty",
      "п·п╠я─п╟пЇпЎп╡п╟пҐп╦п╣": "business.edu",
      "п÷пЎп╦я│п╨ я─п╟п╠пЎя┌я▀": "business.job",
      "п÷я─пЎя└п╣я│я│п╦пЎпҐп╟п╩п╦пЇп╪": "business.school",
      "п═п╣п╨п╩п╟п╪п╟": "business.ad",
      "п╒п╣я┘пҐпЎп╩пЎпЁп╦п╦ пЄп╩я▐ п╠п╦пЇпҐп╣я│п╟": "business.tech",
    },
    business_law,
    business_book,
    business_edu,
    ...
    business_tech,
    business_marketing = {
      "п■п╦я─п╣п╨я┌-п╪п╟я─п╨п╣я┌п╦пҐпЁ": "business.marketing.direct",
      "п≤пҐя┌п╣я─пҐп╣я┌-п╪п╟я─п╨п╣я┌п╦пҐпЁ": "business.marketing.internet",
      "п≤я│я│п╩п╣пЄпЎп╡п╟пҐп╦я▐": "business.marketing.research",
    },
    business_realty = {
      "п≤п©пЎя┌п╣п╨п╟": "business.realty.mortgage",
      "п²пЎп╡пЎя│я┌п╦": "business.realty.realty",
    },
    business_job = {
      "п▓п╟п╨п╟пҐя│п╦п╦": "business.job.vacancy",
      "п·п╠я┐я┤п╣пҐп╦п╣": "business.job.education",
      "п═п╣пЇя▌п╪п╣": "business.job.resume",
    },
    business_school = {
      "п▒п╦пЇпҐп╣я│-пЎп╠я─п╟пЇпЎп╡п╟пҐп╦п╣": "business.school.edu",
      "п°п╣пҐп╣пЄпІп╪п╣пҐя┌": "business.school.manage",
      "пёп©я─п╟п╡п╩п╣пҐп╦п╣ п╨п╟я─я▄п╣я─пЎп╧": "business.school.career",
      "пёп©я─п╟п╡п╩п╣пҐп╦п╣ п©п╣я─я│пЎпҐп╟п╩пЎп╪": "business.school.hr",
    },
    home = {
      "п■п╣я┌п╦": "home.children",
      "п√п╦п╡пЎя┌пҐя▀п╣": "home.animals",
      "п≈пЄпЎя─пЎп╡я▄п╣": "home.health",
      "п≤пҐя┌п╣я─я▄п╣я─": "home.interior",
      "п я┐п╩п╦пҐп╟я─п╦я▐": "home.cookery",
      "п÷пЎп╩п╣пЇпҐя▀п╣ я│пЎп╡п╣я┌я▀": "home.help",
      "п÷я─п╦я─пЎпЄп╟": "home.nature",
      "п═п╣п╪пЎпҐя┌": "home.build",
      "п═пЎя│п╨пЎя┬я▄": "home.luxury",
    },
    home_children = {
      "п▒п╣я─п╣п╪п╣пҐпҐпЎя│я┌я▄ п╦ я─пЎпЄя▀": "home.children.pregnancy",
      "п▓пЎя│п©п╦я┌п╟пҐп╦п╣": "home.children.education",
      "п═п╟пЇп╡п╦я┌п╦п╣": "home.children.development",
      "п║пЎп╡п╣я┌я▀ я─пЎпЄп╦я┌п╣п╩я▐п╪": "home.children.advice",
      "п╗п╨пЎп╩п╟": "home.children.school",
    },
    home_animals = {
      "п▓п╣я┌п╣я─п╦пҐп╟я─п╦я▐": "home.animals.veterinary",
      "п пЎя┬п╨п╦": "home.animals.cat",
      "п÷пЎп╩п╣пЇпҐя▀п╣ я│пЎп╡п╣я┌я▀": "home.animals.advice",
      "п║пЎп╠п╟п╨п╦": "home.animals.dog",
      "пґп╨пЇпЎя┌п╦п╨п╟": "home.animals.exotic",
    },
    home_health = {
      "п■п╦п╣я┌я▀": "home.health.diets",
      "п■пЎп╨я┌пЎя─ пЎя┌п╡п╣я┤п╟п╣я┌": "home.health.doctor",
      "п⌡п╣я┤п╣пҐп╦п╣": "home.health.treatment",
      "п²п╟я─пЎпЄпҐп╟я▐ п╪п╣пЄп╦я├п╦пҐп╟": "home.health.medicine",
      "п·п╠я─п╟пЇ пІп╦пЇпҐп╦": "home.health.life",
      "п÷я─пЎя└п╦п╩п╟п╨я┌п╦п╨п╟": "home.health.preventive",
    },
    home_interior,
    home_cookery = {
      "п▓я▀п©п╣я┤п╨п╟": "home.cookery.batch",
      "п■п╣я│п╣я─я┌я▀": "home.cookery.dessert",
      "п°я▐я│пҐя▀п╣ п╠п╩я▌пЄп╟": "home.cookery.meat",
      "п²п╟п©п╦я┌п╨п╦": "home.cookery.cocktail",
      "п·п╡пЎя┴пҐя▀п╣ п╠п╩я▌пЄп╟": "home.cookery.vegetable",
      "п÷пЎп╩п╣пЇпҐя▀п╣ я│пЎп╡п╣я┌я▀": "home.cookery.advice",
      "п═я▀п╠пҐя▀п╣ п╠п╩я▌пЄп╟": "home.cookery.fish",
      "п║п╟п╩п╟я┌я▀": "home.cookery.salad",
      "п║я┐п©я▀": "home.cookery.soup",
    },
    home_help = {
      "п▒я▀я┌пЎп╡п╟я▐ я┌п╣я┘пҐп╦п╨п╟": "home.help.device",
      "п÷пЎя┌я─п╣п╠п╦я┌п╣п╩я▌": "home.help.consume",
    },
    home_nature,
    home_build,
    home_luxury,
    comp = {
      "IT-пЇп╟я┴п╦я┌п╟": "comp.safety",
      "п▓п╣п╠": "comp.web",
      "п⌠я─п╟я└п╦п╨п╟ п╦ пЄп╦пЇп╟п╧пҐ": "comp.design",
      "п■пЎп╨я┐п╪п╣пҐя┌п╟я├п╦я▐, п╨пҐп╦пЁп╦, я│п╩пЎп╡п╟я─п╦": "comp.paper",
      "п√п╣п╩п╣пЇпЎ": "comp.hard",
      "п≤пЁя─я▀": "comp.games",
      "п≤пҐя┌п╣я─пҐп╣я┌": "comp.inet",
      "п²пЎп╡п╦пҐп╨п╦": "comp.newness",
      "п²пЎп╡пЎя│я┌п╦": "comp.news",
      "п·п╠пЇпЎя─я▀": "comp.review",
      "п·п╠я┐я┤п╣пҐп╦п╣": "comp.edu",
      "п║пЎя└я┌": "comp.soft",
      "п╒п╣я│я┌я▀": "comp.test",
    },
    comp_safety,
    ...
    comp_paper,
    comp_web = {
      "п▒п╩пЎпЁп╦ п╦ п©п╣я─я│пЎпҐп╟п╩я▄пҐя▀п╣ я│п╟п╧я┌я▀": "comp.web.personal",
      "п÷пЎя─я┌п╟п╩я▀": "comp.web.portal",
      "п║пЎпЎп╠я┴п╣я│я┌п╡п╟": "comp.web.community",
    },
    comp_hard = {
      "п║п╣я┌п╦ п╦ я│п╡я▐пЇя▄": "comp.hard.telecom",
    },
    comp_games,
    comp_inet = {
      "п▓п╣п╠-пЄп╦пЇп╟п╧пҐ": "comp.inet.design",
      "п▓п╣п╠-я│я┌я─пЎп╦я┌п╣п╩я▄я│я┌п╡пЎ": "comp.inet.webbuild",
      "п·п╠пЇпЎя─я▀": "comp.inet.review",
      "п÷я─пЎпЄп╡п╦пІп╣пҐп╦п╣ я│п╟п╧я┌пЎп╡. SEO": "comp.inet.search",
    },
    comp_newness,
    comp_news = {
      "п²пЎп╡пЎя│я┌п╦ п╦пҐя┌п╣я─пҐп╣я┌п╟": "comp.news.inet",
      "п²пЎп╡пЎя│я┌п╦ п╨пЎп╪п©я▄я▌я┌п╣я─пҐя▀я┘ п╦пЁя─": "comp.news.games",
    },
    comp_review = {
      "п·п╠пЇпЎя─я▀ п÷п·": "comp.review.soft",
    },
    comp_edu,
    comp_test,
    comp_soft = {
      "3D пЁя─п╟я└п╦п╨п╟": "comp.soft.3d",
      "п▒п╟пЇя▀ пЄп╟пҐпҐя▀я┘": "comp.soft.db",
      "п▒п╦пЇпҐп╣я│": "comp.soft.biz",
      "п⌠я─п╟я└п╦я┤п╣я│п╨п╦п╣ я─п╣пЄп╟п╨я┌пЎя─я▀": "comp.soft.graph",
      "п·п©п╣я─п╟я├п╦пЎпҐпҐя▀п╣ я│п╦я│я┌п╣п╪я▀": "comp.soft.os",
      "п÷я─пЎпЁя─п╟п╪п╪п╦я─пЎп╡п╟пҐп╦п╣": "comp.soft.prog",
      "п÷я─пЎя┤п╣п╣": "comp.soft.others",
      "п║п░п÷п═": "comp.soft.sapr",
      "п÷пЎп╩п╦пЁя─п╟я└п╦я▐": "economics.industry.polygraphy",
      "п÷я─пЎп╪я▀я┬п╩п╣пҐпҐпЎя│я┌я▄": "economics.industry.bll",
      "п÷я─пЎя┤п╣п╣": "economics.industry.other",
      "п═п╣я│я┌пЎя─п╟пҐпҐя▀п╧ п╠п╦пЇпҐп╣я│": "economics.industry.resto",
      "п║п╣п╩я▄я│п╨пЎп╣ я┘пЎпЇя▐п╧я│я┌п╡пЎ п╦ п©п╦я┴п╣п╡п╟я▐ п©я─пЎп╪я▀я┬п╩п╣пҐпҐпЎя│я┌я▄":
        "economics.industry.food",
      "п║я┌я─пЎп╦я┌п╣п╩я▄я│я┌п╡пЎ": "economics.industry.build",
      "п╒пЎя─пЁпЎп╡п╩я▐": "economics.industry.trade",
      "п╒я─п╟пҐя│п©пЎя─я┌ п╦ пЁя─я┐пЇпЎп©п╣я─п╣п╡пЎпЇп╨п╦":
        "economics.industry.trans",
...
function init_upload_file_page_behavior() {
  ...
  // п©пЎпЄя│п╨п╟пЇп╨п╟ пЄп╩я▐ пҐп╣п╟п╡я┌пЎя─п╦пЇпЎп╡п╟пҐпҐпЎп╧ пЇп╟пЁя─я┐пЇп╨п╦ я└п╟п╧п╩п╟.
  $("div.add-file-form input.submit").click(function () {
    if ($("p.grouplabel a.addmeplease").length > 0) {
      show_alert(
        "п▓я│я┌я┐п©п╦я┌п╣ п╡ пЁя─я┐п©п©я┐, я┤я┌пЎп╠я▀ пЄпЎп╠п╟п╡п╩я▐я┌я▄ я└п╟п╧п╩я▀."
      );
      return false;
    }
  });

  $('#namethefile input[name="filename"]').DefaultValue(
    "п²п╟пЇпЎп╡п╦я┌п╣ я└п╟п╧п╩"
  );
}
...
function init_topic_edit_behavior() {
  ...
  // я┐пЄп╟п╩п╣пҐп╦п╣ я└п╟п╧п╩пЎп╡ п╦пЇ я┌пЎп©п╦п╨пЎп╡
  $("form#topic-create a.delete").click(function () {
    var el = this;
    show_confirm_form(
      "п▓я▀ пЄп╣п╧я│я┌п╡п╦я┌п╣п╩я▄пҐпЎ я┘пЎя┌п╦я┌п╣ я┐пЄп╟п╩п╦я┌я▄ я└п╟п╧п╩?",
      {
        show: true,
        callback: function () {
  ...
  if (form.length) {
    ...
    $("a.js", topic_type_control).click(function (e) {
      ...
      if (ttype_id === "ttype_link") {
        ...
        subj_label.text("п■пЎп╠п╟п╡п╦я┌я▄ я│я│я▀п╩п╨я┐:");
        ...
        if (ttype_id === "ttype_poll") {
          ttype_input.val(4);
          subj_label.text("п▓пЎп©я─пЎя│ пЄп╩я▐ пЁпЎп╩пЎя│пЎп╡п╟пҐп╦я▐:");
          poll_fields.show();
          topic_files_wrapper.hide();
        } else if (ttype_id === "ttype_topic") {
          ttype_input.val(0);
          subj_label.text("п²п╟пЇп╡п╟пҐп╦п╣ я┌п╣п╪я▀:");
          poll_fields.hide();
          topic_files_wrapper.show();
        }
  ...
  function add_subscription() {
    ...
    $.post(form.attr("action"), { gid: gid }, function (data) {
      ...
      del.html(
        '<img src="' +
          static_url +
          '/img/ico/delete.png" alt="пёпЄп╟п╩п╦я┌я▄" title="пёпЄп╟п╩п╦я┌я▄"/>'
      );
        ...
        $.getJSON(group_get_lists_url, { name: val }, function (data) {
          ...
          $.each(data, function (i, item) {
            if (i < 10) {
              ...
              var b = $(
                '<p style="margin-top: 1em;"><strong>п÷п╣я─п╡я▀п╣ 10 пҐп╟п╧пЄп╣пҐпҐя▀я┘ я─п╟я│я│я▀п╩пЎп╨. п∙я│п╩п╦ я│я─п╣пЄп╦ пҐп╦я┘ пҐп╣я┌ п╦я│п╨пЎп╪пЎп╧ Б─■ я┐я┌пЎя┤пҐп╦я┌п╣ я│п╩пЎп╡пЎ п©пЎп╦я│п╨п╟.</strong></p>'
              );
          ...
          if (empty == 0) {
            var b = $(
              '<p style="margin-top: 1em;"><strong>п²п╦я┤п╣пЁпЎ пҐп╣ пҐп╟п╧пЄп╣пҐпЎ.</strong></p>'
            );
            b.appendTo(subs_list);
          }
        });
...
function init_group_edit_antispam_behavior() {
  $("#id_antispam_filter").DefaultValue(
    "пЎпЄпҐп╟ я│я┌я─пЎп╨п╟ - пЎпЄпҐпЎ п╟пҐя┌п╦я│п©п╟п╪-п©я─п╟п╡п╦п╩пЎ"
  );
...
function init_group_edit_forum_behavior() {
  ...
  $("#forum-topic-list a.delete").click(function () {
    ...
    show_confirm_form(
      "п▓я▀ пЄп╣п╧я│я┌п╡п╦я┌п╣п╩я▄пҐпЎ я┘пЎя┌п╦я┌п╣ я┐пЄп╟п╩п╦я┌я▄ п╡п╟пІпҐя┐я▌ я┌п╣п╪я┐?",
      {
        show: true,
        callback: function () {
          p.remove();
  ...
  $(".f-invite").submit(function (event) {
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          $("#sendresult")
            .text("п÷я─п╦пЁп╩п╟я┬п╣пҐп╦п╣ пЎя┌п©я─п╟п╡п╩п╣пҐпЎ.")
            .show();
        } else {
          $("#sendresult")
            .text(
              "п÷я─п╦пЁп╩п╟я┬п╣пҐп╦п╣ пҐп╣ пЎя┌п©я─п╟п╡п╩п╣пҐпЎ. п÷пЎп╩я▄пЇпЎп╡п╟я┌п╣п╩я▄ я│ я┌п╟п╨п╦п╪ п╟пЄя─п╣я│пЎп╪ я┐пІп╣ я│я┐я┴п╣я│я┌п╡я┐п╣я┌!"
            )
            .show();
        }
      },
  ...
  interest_list.find("a.delete").click(function () {
    ...
    show_confirm_form(
      "п▓я▀ пЄп╣п╧я│я┌п╡п╦я┌п╣п╩я▄пҐпЎ я┘пЎя┌п╦я┌п╣ я┐пЄп╟п╩п╦я┌я▄ я─п╟пЇпЄп╣п╩?",
      {
        show: true,
        callback: function () {
  ...
  $("select", interest_list).change(function () {
    ...
    if (opt != "-1" && self_topics_count > 0) {
      show_confirm_form(
        "п▓я▀ пЄп╣п╧я│я┌п╡п╦я┌п╣п╩я▄пҐпЎ я┘пЎя┌п╦я┌п╣ п©п╣я─п╣п╪п╣я│я┌п╦я┌я▄ п╡я│п╣ я│пЎпЄп╣я─пІп╦п╪пЎп╣ п╡ пЄя─я┐пЁпЎп╧ я─п╟пЇпЄп╣п╩?",
        {
          show: true,
          callback: function () {
      ...
      show_alert("п═п╟пЇпЄп╣п╩ п©я┐я│я┌.");
    }
    return false;
  });
}
...
function init_group_membership_requests_behavior() {
  ...
  $("a.cancelmemberrequest")
    ...
    .click(function () {
      ...
      show_confirm_form(
        "п▓я▀ пЄп╣п╧я│я┌п╡п╦я┌п╣п╩я▄пҐпЎ я┘пЎя┌п╦я┌п╣ пЎя┌п╪п╣пҐп╦я┌я▄ пЇп╟я▐п╡п╨я┐?",
        {
          show: true,
          callback: function () {
  ...
  $("form.joinbeforepost").submit(function () {
    var self = $(this);
    show_confirm_form(
      "<b>п÷п╦я│п╟я┌я▄ п╡ пЁя─я┐п©п©я┐ п╪пЎпЁя┐я┌ я┌пЎп╩я▄п╨пЎ п╣я▒ я┐я┤п╟я│я┌пҐп╦п╨п╦.</b>",
      {
        show: true,
  ...
  $("button.joinbeforeupload", add_file_form)
    ...
    .click(function () {
      ...
      show_confirm_form(
        "<b>п■пЎп╠п╟п╡п╩я▐я┌я▄ я└п╟п╧п╩я▀ п╡ пЁя─я┐п©п©я┐ п╪пЎпЁя┐я┌ я┌пЎп╩я▄п╨пЎ п╣я▒ я┐я┤п╟я│я┌пҐп╦п╨п╦.</b>",
        {
          show: true,
          text: "п▓я│я┌я┐п©п╦я┌я▄ п╡ пЁя─я┐п©п©я┐",
          callback: function () {
  ...
  /*$('a.joinbeforeview').click(function(){
        ...
        show_confirm_form('<b>п°п╟я┌п╣я─п╦п╟п╩я▀ пЁя─я┐п©п©я▀ пЄпЎя│я┌я┐п©пҐя▀ я┌пЎп╩я▄п╨пЎ п╣п╣ я┐я┤п╟я│я┌пҐп╦п╨п╟п╪.</b>',
            {
                show: true,
                text: 'п▓я│я┌я┐п©п╦я┌я▄ п╡ пЁя─я┐п©п©я┐',
  ...
  $("a.joinbeforeview").click(function () {
    ...
    var messageText = joingroupAdded
      ? "п║п©п╟я│п╦п╠пЎ, п╡п╟я┬п╟ пЇп╟я▐п╡п╨п╟ п╠я┐пЄп╣я┌ я─п╟я│я│п╪пЎя┌я─п╣пҐп╟ п╟пЄп╪п╦пҐп╦я│я┌я─п╟я┌пЎя─пЎп╪ п╡ п╠п╩п╦пІп╟п╧я┬п╣п╣ п╡я─п╣п╪я▐."
      : "п°п╟я┌п╣я─п╦п╟п╩я▀ пЁя─я┐п©п©я▀ пЄпЎя│я┌я┐п©пҐя▀ я┌пЎп╩я▄п╨пЎ п╣п╣ я┐я┤п╟я│я┌пҐп╦п╨п╟п╪.";
    var redirectLink = joingroupAdded
      ? link.replace(/^(\/group\/[^\/]+).*$/, "$1")
      : link + "&join_accepted=1";
    var buttonText = joingroupAdded
      ? "п▓п╣я─пҐя┐я┌я▄я│я▐ пҐп╟пЇп╟пЄ"
      : "п▓я│я┌я┐п©п╦я┌я▄ п╡ пЁя─я┐п©п©я┐";
    ...
    if (topics_container.length) {
      ...
      if (extra_topics_count > 0) {
        ...
        $.each(topic_datas, function (index, data) {
          ...
          if (extra_topics_count > 0) {
            var extra_topics_count_info =
              " п╦ п╣я┴п╣ " + extra_topics_count + " ";
