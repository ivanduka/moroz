...
$(document).ready(function () {
    ...
    $('#js_confirmFormBut').live("click", function () { // ◊◊œƒ Àœƒ¡ –œƒ‘◊≈“÷ƒ≈Œ…—
        if (userinfo['console']) console.log("$(#confirmFormBut).click");
        ajax_confirm();
        return false;
    });

    $(".js_keydown_selector").live("keyup", function (event) {//œ‘”Ã≈÷…◊¡≈Õ Œ¡÷¡‘…≈ 'enter' …Ã… 'esc' Œ¡ ∆œ“Õ≈
        if (event.keyCode == 13) {//Œ¡÷¡Ã… ≈Œ‘≈“
            if (userinfo['console']) console.log(current_login_register_tab);
            if ($(this).data('js_submit') == 'yes') {//need submit
                //”Õœ‘“…Õ - ≈”Ã… ≈”‘ÿ ¡‘‘“…¬’‘ 'js_submit' - ‘œ ‹Õ’Ã…“’≈Õ ÀÃ…À ◊ ⁄¡◊…”…Õœ”‘… œ‘ ‘œ«œ À’ƒ¡ ’À¡÷≈‘ $(this).data('js_action')
...
//◊”–œÕœ«¡‘≈ÃÿŒŸ≈ –≈“≈Õ≈ŒŒŸ≈
var current_login_register_tab = 'js_tab_auth'; //ƒÃ— ¬Ÿ”‘“œ«œ –œŒ…Õ¡Œ…— À¡Àœ  ’ Œ¡” ‘¡¬
...
function _kupivip(email) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {'url': 'http://www.kupivip.ru/account/coregistration', 'partnerId': 'sub_co', 'email': userinfo['email'], 'firstName': 'ÀÃ…≈Œ‘' },
        type: 'POST',
        success: function (data) {
    ...
    $.ajax(
        {
            ...
            success: function (res) {
                ...
                if (match = res.match(/^member\/confirm\/(done|wait.html)$/)) {
                    ...
                    userinfo['confirmed'] = 1; // ⁄¡–œÕ…Œ¡≈Õ, ﬁ‘œ –œÃÿ⁄œ◊¡‘≈Ãÿ –œƒ‘◊≈“ƒ…Ã “≈«…”‘“¡√…¿ …
...
function showAttention(event,shift){
    for(var i=0;i<event.value.length;i++){
        ...
        if(targ>=1034 && targ<=1113) {   //ÀœƒŸ  ¬’À◊ “’””Àœ«œ ¡Ã∆¡◊…‘¡
            var attention = 1;
        }
        //Õ¡Ã≈ŒÿÀ…≈ ¬’À◊Ÿ ” shift  …Ã… ¬œÃÿ€…≈ ¬≈⁄ shift ƒÃ— “’””Àœ«œ … ¡Œ«Ã… ”Àœ«œ ¡Ã∆¡◊…‘¡
...
function parse_result(res, farg) {
    ...
    var msg_id = farg[0]; // id ”Ãœ— ƒÃ— ◊Ÿ◊œƒ¡ ”œœ¬›≈Œ…—
    var info = res.split('|'); // :
    var re = /^error/;
    ...
    if (mf == 1) {// ¡◊‘œ“…⁄¡√…— …Ã… “≈«…”‘“¡√…— –“œ€Ã¡ ’”–≈€Œœ
        ...
        if (msg_id == 'reg_msg') { // ≈”Ã… ◊Ÿ–œÃŒ≈Œ¡ “≈«…”‘“¡√…—
            ...
            eventstat('auth'); // ”ﬁ…‘¡≈Õ ’”–≈€Œ’¿ ¡◊‘œ“…⁄¡√…¿
            if (typeof(aobj) != "undefined") {// ◊Ÿ–œÃŒ—≈Õ œ‘Ãœ÷≈ŒŒœ≈ ¡◊‘œ“…⁄¡√…≈  ƒ≈ ”‘◊…≈
        ...
        if (typeof(aobj) != "undefined") {
            if (aobj.hasClass('subscriberu_subscribe')) {
                ...
                $('.linkconfirm').click( //⁄¡–“œ” Œ¡ –œÃ’ﬁ≈Œ…≈ –…”ÿÕ¡ ”œ ””ŸÃÀœ  ƒÃ— –œƒ–…”À…
                    function () {
                        var data = h2q(h);
                        confirmbyemail(data);
                        return false;
...
function _checkSocConfirm(event) {
    if ($('#js_tab_reg').hasClass('rg_active_nav') && !$('#js_tap_panel_checkbox_terms_reg').is(':checked')) {
        //$('#reg_msg_soc').html('<span style="color:red">–œƒ‘◊≈“ƒ…‘≈ ”œ«Ã¡”…≈ ” ’”Ãœ◊…—Õ… –œÃÿ⁄œ◊¡Œ…—</span>');  //
...
/**
 * ‰œ¬¡◊Ã≈Œ…≈ À’À… (ƒÃ— “≈ÀÃ¡ÕŒŸ» √≈Ã≈ )
 * @author Vajen */
function setCookie(id){
    var date = new Date;
    date.setDate(date.getDate() + 180);  // Œ¡ 180 ƒŒ≈ 
...
// vajen: –ø—Ä–æ–≤–µ—Ä–∫–∞ –ø–æ–ª–µ–π —Ñ–æ—Ä–º—ã group/create




    // vajen: –∑–∞–º–µ–Ω–∞ –Ω–µ–ø–µ—á–∞—Ç–∞–µ–º—ã—Ö –¥–µ—Å—è—Ç–∏—á–Ω—ã—Ö html-–∫–æ–¥–æ–≤ –Ω–∞ hex(–Ω–∞—Ü. –∞–ª—Ñ–∞–≤–∏—Ç—ã) (—Å—Ç—Ä–∞–Ω–∏—Ü—ã —Ä–∞—Å—Å—ã–ª–æ–∫)
...
// —á—Ç–æ –¥–µ–ª–∞—Ç—å –ø–æ—Å–ª–µ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏
var subscriberu = {
...
$.blockUI.defaults.css = {}; // —Å–±—Ä–æ—Å –Ω–∞—Å—Ç—Ä–æ–µ–∫ css –¥–ª—è –±–ª–æ–∫–∏—Ä–∞—Ç–æ—Ä–∞
...
var userinfo = {
    ...
    'aobj': null,
    'extquick': 0,
    'confirmed': 0, // –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–Ω—ã–π –∞–∫–∫–∞—É–Ω—Ç
    'recommendation': 0, // —Ä–µ–∫–æ–º–µ–Ω–¥–∞—Ü–∏—è —Ä–∞—Å—Å—ã–ª–æ–∫ –∏ –¥–∞–π–¥–∂–µ—Å—Ç–æ–≤
    'eq': {
        'redirect': '',
        'email': '',
        'grp': '',
...
var aobj; // –æ–±—ä–µ–∫—Ç –≤—ã–±—Ä–∞–Ω–Ω–æ–π —Å—Å—ã–ª–∫–∏ (–¥–ª—è –ø–æ—Å–ª–µ–¥—É—é—â–∏—Ö –¥–µ–π—Å—Ç–≤–∏–π (–ø–æ–¥–ø–∏—Å–∫–∞, –≤—Å—Ç—É–ø–ª–µ–Ω–∏–µ –≤ –≥—Ä—É–ø–ø—É, etc))               

var ui = { 'pbimg': '<img src="/img/progressbar.gif" width=32 heigth=32/>'};

var ajax_url = {
    'auth': '/MEMBERLOGIN_authen_cred', //–∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏—è
    'reg': '/member/join', //—Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏—è
    'recall': '/member/info', //–Ω–∞–ø–æ–º–∏–Ω–∞–Ω–∏–µ –ø–∞—Ä–æ–ª—è
    'subscribe': '/member', // –ø–æ–¥–ø–∏—Å–∫–∞
    'love': '/member/love', // –≤ –∏–∑–±—Ä–∞–Ω–Ω–æ–µ (–≤ –¥—Ä—É–∑—å—è)
    'quick': '/member/quick', // –±—ã—Å—Ç—Ä–∞—è –ø–æ–¥–ø–∏—Å–∫–∞
    'update': '/member/sub', // –∞–Ω–∫–µ—Ç–∞
    'profile': '/member/profile', // –ø—Ä–æ—Ñ–∏–ª—å –ø–æ–¥–ø–∏—Å—á–∏–∫–∞
    'confirm': '/member/confirm' // –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏–µ –∞–∫–∫–∞—É–Ω—Ç–∞
...
function eventstat(e) {
    ...
    var i = $('<img></img>').hide().appendTo('body'); // —Å–æ–∑–¥–∞–µ–º —Å–∫—Ä—ã—Ç—ã–π —ç–ª–µ–º–µ–Ω—Ç
    i.attr('id', 'esi'); // –∏–¥–µ–Ω—Ç–∏—Ñ–∏—Ü–∏—Ä—É–µ–º
    i.attr('src', src); // –∑–∞–≥—Ä—É–∂–∞–µ–º
    i.remove();
};

// –≤—ã–ø–æ–ª–Ω—è–µ—Ç –æ—Ç–ª–æ–∂–µ–Ω–Ω–æ–µ (–∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–µ–π –Ω–∞ –¥—Ä—É–≥–æ–º —Å–∞–π—Ç–µ) –¥–µ–π—Å—Ç–≤–∏–µ
function dosuspended() {
    if (typeof($.cookie) == 'function') { // –µ—Å—Ç—å –∫—É–∫–∏
        var suspended = $.cookie('Felissuspended'); // –æ—Ç–ª–æ–∂–µ–Ω–Ω–æ–µ –¥–µ–π—Å—Ç–≤–∏–µ
...
function quickFormOk() {
    ...
    //$('#trtypeauth').hide(); // —Å–∫—Ä—ã–≤–∞–µ–º —Ä–∞–¥–∏–æ–∫–Ω–æ–ø–∫–∏ –≤—ã–±–æ—Ä–∞ —Ç–∏–ø–∞ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏/—Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
}

// –≤—ã–≤–æ–¥ —Ñ–æ—Ä–º—ã –ø—Ä–æ–≤–µ—Ä–∫–∏ –∏ –¥–æ–±–∞–≤–ª–µ–Ω–∏—è –Ω–∏–∫–∞
function shownickForm() {
    var blockmsg = '#nickForm';
    $('#nick_msg').html('');
    $('#nickFormBut').attr('disabled', ''); // –≤–∫–ª—é—á–∞–µ–º –∫–Ω–æ–ø–∫—É
    $('.subscriberu_popup').hide(); // –∑–∞–∫—Ä—ã–≤–∞–µ–º –≤—Å–µ –¥—Ä—É–≥–∏–µ —Ñ–æ—Ä–º—ã
    $.blockUI.defaults.focusInput = true;
    $.blockUI({ message: $(blockmsg) });
    $('.blockOverlay').attr('title', uimsg['unblock']).click(function () {
        hidebo();
...
/* GiN hands (go to login_register_form.js)
 // –≤—ã–≤–æ–¥ —Ñ–æ—Ä–º—ã –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏—è –∞–∫–∫–∞—É–Ω—Ç–∞
 function showconfirmForm(arg){
 defblockUI();
 var blockmsg = '#confirmForm';
 $('#needconfirmcode').attr('href', '/member/info?email=' + userinfo['email']);
 $('#confirm_email').text(userinfo['email']); // —É—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞–µ–º –∞–¥—Ä–µ—Å –≤ —Ç–µ–∫—Å—Ç
 $('.subscriberu_popup').hide(); // –∑–∞–∫—Ä—ã–≤–∞–µ–º –≤—Å–µ –¥—Ä—É–≥–∏–µ —Ñ–æ—Ä–º—ã
 $.blockUI.defaults.focusInput = true;
 $.blockUI({ message: $(blockmsg) });
 }
...
$('#needconfirmcode').live('click', function () { // –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏–µ —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
...
function showquickForm(arg) {
    ...
    $('#email_msg').text('');
    $('#qf_tapanel').show();
    $('#quickFormSubBut').attr('disabled', ''); // –≤–∫–ª—é—á–∞–µ–º –∫–Ω–æ–ø–∫—É
    $('#subscriberu_email_pb').html(''); // –≤—ã–∫–ª—é—á–∞–µ–º –≥—Ä–∞–¥—É—Å–Ω–∏–∫
    if (!arg) {
        arg = {'quickForminputblock': 1, 'quickFormSubBut': 1, 'quickFormCloseBut': 0, 'quickFormNextBut': 0};
    }// –≤—ã–≤–æ–¥–∏–º —ç–ª–µ–º–µ–Ω—Ç—ã –ø–æ —É–º–æ–ª—á–∞–Ω–∏—é
...
function hidebo() {  // hide block overlay
    ...
    var ccf = $('#confirm_code').length; // –ø–æ–ª–µ –¥–ª—è –≤–≤–æ–¥–∞ –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏—è

    if (userinfo['console']) console.log('function hidebo()');
    $.blockUI.defaults.overlayCSS.opacity = 0.3;
    if (typeof(aobj) != "undefined") {
        if (aobj.attr('id') == 'autoclick') {
            var d = document.domain.match(/subscribe\.ru/) ? document.domain : 'subscribe.ru'; // –≤–¥—Ä—É–≥ –æ—Ç–∫—Ä—ã–ª–∏ –∏–∑ –∫–µ—à–∞ - –¥–æ–º–µ–Ω –ü–°
            var url = 'http://' + d + '/group/'; // –≥–ª–∞–≤–Ω–∞—è –≥—Ä—É–ø–ø
            if (aobj.attr('href').match(/redirect_to\=\/group\/(.+?)\//)) {
                //url += RegExp.$1 + '/'; // –∫–æ—Ä–Ω–µ–≤–∞—è –∫–æ–Ω–∫—Ä–µ—Ç–Ω–æ–π –≥—Ä—É–ø–ø—ã
                url += RegExp.$1; // –∫–æ—Ä–Ω–µ–≤–∞—è –∫–æ–Ω–∫—Ä–µ—Ç–Ω–æ–π –≥—Ä—É–ø–ø—ã
...
//\GiN fast fix !!!
    ...
    if (ccf) { // –Ω–∞ —Ñ–æ—Ä–º–µ –±—ã–ª–æ –ø–æ–ª–µ –≤–≤–æ–¥–∞ –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏—è, –∏ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å - –∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–Ω
...
function h2q(h) { // –ø—Ä–µ–æ–±—Ä–∞–∑—É–µ—Ç —Ö–µ—à –≤ —Å—Ç—Ä–æ–∫—É –ø–∞—Ä–∞–º–µ—Ç—Ä–æ–≤ (p1=v1&p2=v2&...&pN=vN)
    var res = [];
    var i = 0;
    $.each(h, function (key) {
        if (i > 0) res.push('&');
...
function pbshow(id) {
    var pb = $('#' + id);
    pb.html(ui['pbimg']);
    pb.show(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º –ø—Ä–æ–≥—Ä–µ—Å—Å-–±–∞—Ä
}
...
/* GiN hands
 ...
 pbshow('subscriberu_authform_pb'); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º –ø—Ä–æ–≥—Ä–µ—Å—Å-–±–∞—Ä
 $.ajax({
 'type' : 'POST',
 'url' :  ajax_url['quick'],
 'data' :  data,
 ...
 showquickForm(farg);
 $('#qf_tapanel').hide();
 $('#trpwd').show(); // –ø–æ–ª–µ –¥–ª—è –≤–≤–æ–¥–∞ –ø–∞—Ä–æ–ª—è
...
$(document).ready(function () {
    if (typeof($.cookie) == 'function') { // –µ—Å—Ç—å –∫—É–∫–∏
        var vkcontent = $.cookie('FelisVKontakte'); // –ø—Ä–æ–≤–µ—Ä—è–µ–º - –ø—Ä–∏—à–ª–∏ —Å vk?
        $.cookie('FelisVKontakte', null, {path: '/'});
        var mrucontent = $.cookie('FelisMailRu'); // –ø—Ä–æ–≤–µ—Ä—è–µ–º - –ø—Ä–∏—à–ª–∏ —Å mailru?
        ...
        if (vkcontent != null && vkcontent != '') {
            ...
            if (vkcontent == 'login') {
                ...
                showquickForm(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º —Ñ–æ—Ä–º—É –±—ã—Å—Ç—Ä–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
                quickFormOk(); // –≤—ã–≤–æ–¥–∏–º –≤ —Å–æ–∫—Ä–∞—â–µ–Ω–Ω–æ–º –≤–∏–¥–µ
    ...
    $('div.taitem').click(function (e) {
        ...
        if ($(this).attr('id').match(/^(q|l|r)fta_(.+?)$/)) {
            ...
            if ($('#quickForm').is(':visible')) { // –µ—Å–ª–∏ —ç—Ç–æ —Ñ–æ—Ä–º–∞ –±—ã—Å—Ç—Ä–æ–π –ø–æ–¥–ø–∏—Å–∫–∏

                if (ta != 'vkontakte' && ta != 'mailru') $('#authidcpt').html(uimsg[ta + 'cpt']);
                $('#quickForminputblock')[ta == 'vkontakte' || ta == 'mailru' ? 'hide' : 'show']();

            } else if ($('#loginForm').is(':visible')) { // —Ñ–æ—Ä–º–∞ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏
            ...
            } else if ($('#regForm').is(':visible')) { // —Ñ–æ—Ä–º–∞ —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
                if (ta == 'email') {
                    $(".trrf").show();
                    $("#trrfid").hide();
                } else if (ta == 'openid') {
    ...
    // –ø—É–±–ª–∏–∫–∞—Ü–∏—è –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏—è –≤ —Ç–µ–º–µ –≥—Ä—É–ø–ø—ã
    $('[id^=public_]').live("click", function (e) {
        ...
        var link = $(this).attr('href'),
            ...
            commid = comm.attr('id'),
            pub = $(this);
        //console.log('–û–ø—É–±–ª–∏–∫–æ–≤–∞—Ç—å? '+link+' comm='+comm+' public='+pub);
        $.ajax({
            'type': 'POST',
            'url': link,
            success: function(data)
            {
                ...
                var answer = '<a href="#" comment_id="'+commid+'" onclick="show_comment_form('+commid+'); return false;" rel="'+commid+'" class="com_reply">–û—Ç–≤–µ—Ç–∏—Ç—å</a>';
    ...
    // —É–¥–∞–ª–µ–Ω–∏–µ –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏—è –≤ —Ç–µ–º–µ –≥—Ä—É–ø–ø—ã
        ...
        show_confirm_form(uimsg['doyouwantdeletecomment'],
            {
                ...
                callback: function () {
                    ...
                    if(allcomments){
                        comm.find('.content').before('<div class="del_note">–ö–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π —É–¥–∞–ª–µ–Ω, –µ–≥–æ –≤–∏–¥—è—Ç —Ç–æ–ª—å–∫–æ –º–æ–¥–µ—Ä–∞—Ç–æ—Ä—ã –≥—Ä—É–ø–ø—ã –∏ –µ–≥–æ –∞–≤—Ç–æ—Ä</div>');
                    } else {
                        comm.find('.content').prepend('<div>–ö–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π —É–¥–∞–ª–µ–Ω, –µ–≥–æ –≤–∏–¥—è—Ç —Ç–æ–ª—å–∫–æ –º–æ–¥–µ—Ä–∞—Ç–æ—Ä—ã –≥—Ä—É–ø–ø—ã –∏ –µ–≥–æ –∞–≤—Ç–æ—Ä</div>');
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(data)
                        {
                            ...
                            if (result['error'] == 'error/delete/comments/norights') {
                                alert('–£ –≤–∞—Å –Ω–µ —Ö–≤–∞—Ç–∞–µ—Ç –ø—Ä–∞–≤ –¥–ª—è —É–¥–∞–ª–µ–Ω–∏—è —ç—Ç–æ–≥–æ –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏—è. –û–±—Ä–∞—Ç–∏—Ç–µ—Å—å –∫ –∞–¥–º–∏–Ω–∏—Å—Ç—Ä–∞—Ç–æ—Ä—É –≥—Ä—É–ø–ø—ã');
    ...
    // —É–¥–∞–ª–µ–Ω–∏–µ –≤—Å–µ—Ö –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏–µ–≤ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è –≤ –≥—Ä—É–ø–ø–µ
    ...
    // —É–¥–∞–ª–∏—Ç—å –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π –∏ –∑–∞–±–∞–Ω–∏—Ç—å –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è –≤ –≥—Ä—É–ø–ø–µ
        ...
        show_confirm_form(uimsg['deletecommentbanneduser'],
            {
                ...
                callback: function () {
                    comm.addClass('deleted');
                    comm.find('.content').prepend('<div>–ö–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π —É–¥–∞–ª–µ–Ω, –µ–≥–æ –≤–∏–¥—è—Ç —Ç–æ–ª—å–∫–æ –º–æ–¥–µ—Ä–∞—Ç–æ—Ä—ã –≥—Ä—É–ø–ø—ã, –µ–≥–æ –∞–≤—Ç–æ—Ä –∑–∞–±–∞–Ω–µ–Ω</div>');
                    del.closest('.act').hide();
                    $.ajax({
                        'type': 'POST',
                        'url': dellink,
    ...
    // –∑–∞–±–∞–Ω–∏—Ç—å –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è –≤ –≥—Ä—É–ø–ø–µ
    ...
    // —Ä–∞–∑–±–∞–Ω–∏—Ç—å –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è –≤ –≥—Ä—É–ø–ø–µ
    ...
    // –≤–æ—Å—Å—Ç–∞–Ω–æ–≤–ª–µ–Ω–∏–µ —É–¥–∞–ª–µ–Ω–Ω–æ–≥–æ –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏—è –≤ —Ç–µ–º–µ –≥—Ä—É–ø–ø—ã
    ...
    // –∏–∑–º–µ–Ω–µ–Ω–∏–µ\–¥–æ–±–∞–≤–ª–µ–Ω–∏–µ –º–µ—Ç–∫–∏ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è
    ...
    // –ø—Ä–∏–Ω—è—Ç—å –∑–∞—è–≤–∫—É –Ω–∞ —É—á–∞—Å—Ç–∏–µ –≤ –≥—Ä—É–ø–ø–µ
    $('button.accept').live("click", function (e) {
        ...
        formtag.find('button.accept').text('–ü—Ä–∏–Ω—è—Ç–æ').removeClass('button-orange').addClass('button-green');
    ...
    // –æ—Ç–∫–ª–æ–Ω–∏—Ç—å –∑–∞—è–≤–∫—É –Ω–∞ —É—á–∞—Å—Ç–∏–µ –≤ –≥—Ä—É–ø–ø–µ
    $('button.cancel').live("click", function (e) {
        var formtag = $(this).closest('form'),
            memberid = formtag.find('input[name=member]').val(),
            declButton = formtag.find('button[name=decline]').val();
        formtag.find('button.cancel').text('–û—Ç–∫–ª–æ–Ω–µ–Ω–æ').removeClass('button-grey').addClass('button-red');
        formtag.find('button').attr('disabled',true);
        $.ajax({
            type: 'POST',
    ...
    // –∫–Ω–æ–ø–∫–∞ —Å –ø–æ–ø–∞–ø–æ–º "–∞–¥–º–∏–Ω–∏—Å—Ç—Ä–∏—Ä–æ–≤–∞—Ç—å" –≤ –≥—Ä—É–ø–ø–∞—Ö
    ...
    // –æ–±—Ä–∞–±–∞—Ç—ã–≤–∞–µ–º tab –∏ esc –Ω–∞ —Ä–∞–¥–∏–æ–∫–Ω–æ–ø–∫–µ —Å–º–µ–Ω—ã —Ñ–æ—Ä–º–∞—Ç—ã —Ä–∞—Å—Å—ã–ª–∫–∏ –∏ –¥–∏—Å–∫. –ª–∏—Å—Ç–∞
    function lfesc(obj) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.match(/^member\/update\/done ank$/)) {
                        $('#ankst').show(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º, —á—Ç–æ –¥–µ–π—Å—Ç–≤–∏–µ –≤—ã–ø–æ–ª–Ω–µ–Ω–æ
                        obj.attr("disabled", "disabled"); // –≤—ã–∫–ª—é—á–∞–µ–º –∫–Ω–æ–ø–∫—É
                        $.each(a, function (i) {
    ...
    // –ø–æ–¥–ø–∏—Å–∫–∞ –Ω–∞ —Ä–µ–∫–ª–∞–º–Ω—ã–µ –º–∞—Ç–µ—Ä–∏–∞–ª—ã (optin)
    ...
    // –æ–±—Ä–∞–±–æ—Ç—á–∏–∫ –Ω–∞ –¥–µ–π—Å—Ç–≤–∏–µ –∞–Ω–∫–µ—Ç–Ω—ã—Ö –ø–µ—Ä–µ–∫–ª—é—á–∞—Ç–µ–ª–µ–π –∏ —Ä–∞–¥–∏–æ–∫–Ω–æ–ø–æ–∫
    function ank_click(obj) {
        ...
        $.ajax({
            ...
            success: function (res) {
                res = res.split(/\n/)[0];
                if (res.match(/^member\/update\/done ank$/)) {
                    if (obj.attr('type') == 'radio') { // –µ—Å–ª–∏ –º–Ω–æ–∂–µ—Å—Ç–≤–µ–Ω–Ω—ã–π –≤—ã–±–æ—Ä,
                        var a = $(':radio[name=' + obj.attr('name') + ']');
                        $.each(a, function (i) {
                            a[i].disabled = true;
                        }); // –≤—ã–∫–ª—é—á–∞–µ–º –≤—Å–µ —ç–ª–µ–º–µ–Ω—Ç—ã
                    } else {
                        obj.attr("disabled", "disabled"); // –≤—ã–∫–ª—é—á–∞–µ–º –∫–Ω–æ–ø–∫—É
                    }
                    $('#l' + obj.attr('name')).css('color', 'gray');
    ...
    // –∑–∞–∫—Ä—ã–≤–∞–µ–º –±–ª–æ–∫ –∏ –ø–æ–∑–∏—Ü–∏–æ–Ω–∏—Ä—É–µ–º—Å—è –Ω–∞ —ç–ª–µ–º–µ–Ω—Ç–µ —É–ø—Ä–∞–≤–ª–µ–Ω–∏—è,
    // vajen: —É–±–∏—Ä–∞–µ–º –∫–ª–∞—Å—Å active  —É –∫–Ω–æ–ø–∫–∏
    function scroll2gear(id) {
        $('#fb' + id).hide();
        //var to = $('#sg' + id).offset().top; // –ø–æ–∑–∏—Ü–∏–æ–Ω–∏—Ä—É–µ–º—Å—è
    ...
    $('.cssbtn').click(function () {
        var id = $(this).attr('id');
        if (id.match(/^cssbtn(\d+?)$/)) { // –∑–∞–∫—Ä—ã–≤–∞–µ–º –±–ª–æ–∫ —Å —Ñ–æ—Ä–º–æ–π –≤—ã–±–æ—Ä–æ—á–Ω–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
            id = RegExp.$1
            scroll2gear(id);
        }
    })

    // –∑–∞–ø—Ä–æ—Å –Ω–∞ –≤—ã–±–æ—Ä–æ—á–Ω—É—é –ø–æ–¥–ø–∏—Å–∫—É
    $('.ssbtn').click(function () {
        //if (userinfo.authorized==0){
        if ($('.subscriberu_unknown').length) { // –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –Ω–µ –∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–Ω
            aobj = $(this);
            //showquickForm();
            showloginForm();
            return;
        ...
        var data = res.join('&'); // —Ñ–æ—Ä–º–∏—Ä—É–µ–º –∑–∞–ø—Ä–æ—Å
        var pb = $(this).parent('form').children('div.subscriberu_pb');
        pb.html(ui['pbimg']); // –≤–∫–ª—é—á–∞–µ–º –≥—Ä–∞–¥—É—Å–Ω–∏–∫
        pb.show();
        $.ajax({
            type: 'POST',
            url: ajax_url['update'],
            ...
            dataType: 'text',
            success: function (data) {
                pb.hide(); //html(''); // —É–±–∏—Ä–∞–µ–º –≥—Ä–∞–¥—É—Å–Ω–∏–∫
                if (id.match(/^ssbtn(\d+?)$/)) { // –∑–∞–∫—Ä—ã–≤–∞–µ–º –±–ª–æ–∫ —Å —Ñ–æ—Ä–º–æ–π
                    var redirect = '';
                    var reload = 0;
                    if (userinfo['authorized'] == 1) { // –µ—Å–ª–∏ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–ª—Å—è
                        redirect = subscriberu['ssbtn']['redirect'];
                        reload = subscriberu['ssbtn']['reload'];
                        doR(redirect, reload); // –≤—ã–ø–æ–ª–Ω—è–µ–º —Ä–µ–¥–∏—Ä–µ–∫—Ç –∏–ª–∏ –ø–µ—Ä–µ–∑–∞–≥—Ä—É–∑–∫—É —Å—Ç—Ä–∞–Ω–∏—Ü—ã
                    }
                    id = RegExp.$1
                    // –º–µ–Ω—è–µ–º –∞–Ω–∫–æ—Ä—ã –∏ —Å—Å—ã–ª–∫–∏ –ø–æ–¥–ø–∏—Å–Ω—ã—Ö —Å—Å—ã–ª–æ–∫
                    var lid = '.l' + id;
    ...
    // –æ—Ç–∫—Ä—ã—Ç–∏–µ/–∑–∞–∫—Ä—ã—Ç–∏–µ —Ñ–æ—Ä–º—ã –≤—ã–±–æ—Ä–æ—á–Ω–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
    $(".subscriberu_selection_gear").live('click', function () {
        if ($(this).attr('id').match(/^sg(\d+?)$/)) {
            ...
            // –∑–∞–∫—Ä—ã–≤–∞–µ–º –≤—Å–µ –æ—Ç–∫—Ä—ã—Ç—ã–µ –±–ª–æ–∫–∏ –∫—Ä–æ–º–µ —Ç–µ–∫—É—â–µ–≥–æ
            ...
            $(fid).children('div.subscriberu_pb').hide(); //html(''); // –≥—Ä–∞–¥—É—Å–Ω–∏–∫
    ...
    if ($('#archsearchq').length) { // –µ—Å–ª–∏ –Ω–∞ —Å—Ç—Ä–∞–Ω–∏—Ü–µ –µ—Å—Ç—å –ø–æ–ª–µ –ø–æ–∏—Å–∫–∞ –ø–æ –∞—Ä—Ö–∏–≤—É
        $("#archsearchq").val(uimsg['archsearchtext']); // –∏–Ω–∏—Ü–∏–∞–ª–∏–∑–∏—Ä—É–µ–º –µ–≥–æ
    }

    // –µ—Å–ª–∏ –≤ –ø–æ–∏—Å–∫–æ–≤–æ–º –∑–∞–ø—Ä–æ—Å–µ —É–∫–∞–∑–∞–Ω –ø–æ—è—Å–Ω–∏—Ç–µ–ª—å–Ω—ã–π —Ç–µ–∫—Å—Ç, –æ—Ç–ø—Ä–∞–≤–ª—è–µ–º –ø—É—Å—Ç–æ–π –∑–∞–ø—Ä–æ—Å
...
//   }
    ...
    $(".fff").submit(function () {
        return false;
    }); // –±–ª–æ–∫–∏—Ä—É–µ–º –æ—Ç–ø—Ä–∞–≤–∫—É –¥–∞–Ω–Ω—ã—Ö —Ñ–æ—Ä–º—ã
    ...
    $('.fx').click(function () { // –æ–±—â–µ–µ –∑–∞–∫—Ä—ã—Ç–∏–µ —Ñ–æ—Ä–º—ã-–±–ª–æ–∫–∞ - –ø–æ –∫–ª–∞—Å—Å—É
        if ($(this).attr('id') == 'fxq') { // –µ—Å–ª–∏ —ç—Ç–æ —Ñ–æ—Ä–º–∞ –≤–≤–æ–¥–∞ –∞–Ω–∫–µ—Ç—ã
            if (userinfo['newreg'] == 1 || userinfo['extquick'] == 2) { // –¥–ª—è –Ω–æ–≤–æ–π —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏ –Ω–µ –≤—ã–≤–æ–¥–∏–º —Å–æ–æ–±—â–µ–Ω–∏–µ
                if (userinfo['vk']['event'] != '' || userinfo['mru']['event'] != '') { // –µ—Å–ª–∏ –ø—Ä–∏—à–ª–∏ –∏–∑ –∫–æ–Ω—Ç–∞–∫—Ç–∞ –∏–ª–∏ mailru
                    return dosuspended();
                }
                if (userinfo['aobj'] != null) userinfo['aobj'].click(); // –≤—ã–ø–æ–ª–Ω—è–µ–º –æ—Ç–ª–æ–∂–µ–Ω–Ω–æ–µ –¥–µ–π—Å—Ç–≤–∏–µ
            } else {
                userinfo['new'] = 1; // —Ñ–∏–∫—Å–∏—Ä—É–µ–º, —á—Ç–æ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –Ω–æ–≤—ã–π
                if (userinfo['confirmed'] != 1) {
                    showquickForm(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º —Ñ–æ—Ä–º—É –±—ã—Å—Ç—Ä–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
                    quickFormOk(); // –≤—ã–≤–æ–¥–∏–º –≤ —Å–æ–∫—Ä–∞—â–µ–Ω–Ω–æ–º –≤–∏–¥–µ
                    show_msg('email_msg', uimsg['congradulation'], 1); // —Å–æ–æ–±—â–µ–Ω–∏–µ –æ–± —É—Å–ø–µ—à–Ω–æ–π —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
                } else {
                    hidebo();
                }
                return;
    ...
    // –∑–∞–ø–∏—Å—ã–≤–∞–µ–º –≤ –∫—É–∫—É href —ç–ª–µ–º–µ–Ω—Ç–∞, –≤—ã–ø–æ–ª–Ω–µ–Ω–∏–µ –¥–µ–π—Å—Ç–≤–∏—è –∫–æ—Ç–æ—Ä–æ–≥–æ –æ—Ç–∫–ª–∞–¥—ã–≤–∞–µ–º –¥–æ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏—è –∏–ª–∏ —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
    function a2c() { // a2c - action to cookie
        if (typeof($.cookie) == 'function') { // –µ—Å—Ç—å –∫—É–∫–∏
            if (aobj != null) { // –µ—Å–ª–∏ –æ–±—ä–µ–∫—Ç –æ–ø—Ä–µ–¥–µ–ª–µ–Ω
                //alert('a2c');
                if (typeof(aobj.attr('href')) != 'undefined') { // —ç–ª–µ–º–µ–Ω—Ç - –≥–∏–ø–µ—Ä—Å—Å—ã–ª–∫–∞
    ...
    /* GiN hands
     // –æ—Ç–ø—Ä–∞–≤–∫–∞ –¥–∞–Ω–Ω—ã—Ö –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏
     $('#loginFormBut').click(function(){
     if ($("#lf_typeauthid").val() == 'openid'){
     var url;
     if ($('#loginFormBut').val() == subscriberu_but_cpt['joingroup']){ // –µ—Å–ª–∏ –≤—Å—Ç—É–ø–∞–µ–º –≤ –≥—Ä—É–ø–ø—É
    ...
    $('#qFormSubBut').click( // —Å–æ—Ö—Ä–∞–Ω–µ–Ω–∏–µ –¥–∞–Ω–Ω—ã—Ö –∞–Ω–∫–µ—Ç—ã
        function () {
            $(this).attr("disabled", "disabled"); // –≤—ã–∫–ª—é—á–∞–µ–º –∫–Ω–æ–ø–∫—É
            var res = [];
            var data;
            ...
            pb.html(ui['pbimg']); // –≤—ã–≤–æ–¥–∏–º –ø—Ä–æ–≥—Ä–µ—Å—Å–±–∞—Ä
            pb.show();
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.match(/^member\/update\/done ank$/)) {
                        if (userinfo['newreg'] == 1 || userinfo['extquick'] == 2) { // –¥–ª—è –Ω–æ–≤–æ–π —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏ –Ω–µ –≤—ã–≤–æ–¥–∏–º —Å–æ–æ–±—â–µ–Ω–∏–µ
                            hidebo();
                            if (userinfo['vk']['event'] != '') { // –µ—Å–ª–∏ –ø—Ä–∏—à–ª–∏ –∏–∑ –∫–æ–Ω—Ç–∞–∫—Ç–∞
                                return dosuspended();
                            }
                            if (userinfo['aobj'] != null) userinfo['aobj'].click(); // –≤—ã–ø–æ–ª–Ω—è–µ–º –æ—Ç–ª–æ–∂–µ–Ω–Ω–æ–µ –¥–µ–π—Å—Ç–≤–∏–µ
                        } else {
                            userinfo['new'] = 1; // —Ñ–∏–∫—Å–∏—Ä—É–µ–º, —á—Ç–æ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –Ω–æ–≤—ã–π
                            if (userinfo['confirmed'] != 1) { // –µ—Å–ª–∏ –µ—â–µ –Ω–µ –ø–æ–¥—Ç–≤–µ—Ä–¥–∏–ª —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏—é
                                showquickForm(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º —Ñ–æ—Ä–º—É –±—ã—Å—Ç—Ä–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
                                quickFormOk(); // –≤—ã–≤–æ–¥–∏–º –≤ —Å–æ–∫—Ä–∞—â–µ–Ω–Ω–æ–º –≤–∏–¥–µ
                                show_msg('email_msg', uimsg['congradulation'], 1); // —Å–æ–æ–±—â–µ–Ω–∏–µ –æ–± —É—Å–ø–µ—à–Ω–æ–π —Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
                            } else {
                                hidebo(); // –ø—Ä–æ—Å—Ç–æ –∑–∞–∫—Ä—ã–≤–∞–µ–º –æ–∫–Ω–æ
                            }
                        }
                    } else {
    ...
    // –≤—ã–≤–æ–¥ —Ñ–æ—Ä–º—ã –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏ —Ç–æ–ª—å–∫–æ —Å –ø–∞—Ä–æ–ª–µ–º
    function showpwdform(arg) {
        userinfo['recommendation'] = 1;
        showloginForm(); // –≤–≤–µ—Å—Ç–∏ –ø–∞—Ä–æ–ª—å

        var cb = $(":checkbox[name=addgrp]");
        cb.attr("checked", ""); // –≤—ã–∫–ª—é—á–∞–µ–º –≤—Å–µ —Ñ–ª–∞–∂–∫–∏
        ...
        if (userinfo['defgrplist'] != '' && typeof(userinfo['defgrplist']) != "undefined") {
            ...
            for (i = 0; i < cb.length; i++) {
                if (cb[i].value.match(pattern)) {
                    cb[i].checked = true; // –æ—Ç–º–µ—á–∞–µ–º —Ä–µ–∫–æ–º–µ–Ω–¥–æ–≤–∞–Ω–Ω—ã–µ –¥–∞–π–¥–∂–µ—Å—Ç—ã –∏ —Ä–∞—Å—Å—ã–ª–∫–∏
                }
            }
        }
        if (userinfo['console']) console.log('cb length = ' + cb.length);
        $('#tremail').hide(); // —Å–∫—Ä—ã–≤–∞–µ–º –ø–æ–ª–µ email
        $('#trpwd').show(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º –ø–æ–ª–µ –ø–∞—Ä–æ–ª—è
        $('#lf_tapanel').hide();
        $('#loginFormCpt').css('margin-left', '3em');
        $('#loginFormBut').val(subscriberu_but_cpt['subscribe']);
        $('#credential_0').attr('value', arg['email']); // —É—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞–µ–º –∞–¥—Ä–µ—Å –≤ —Å–∫—Ä—ã—Ç–æ–µ –ø–æ–ª–µ
        changelinkrecall(1); // –≤–∫–ª—é—á–∞–µ–º —Å—Å—ã–ª–∫—É –Ω–∞–ø–æ–º–∏–Ω–∞–Ω–∏—è
        var msg = uimsg['quickadd'].replace('XXX', arg['email']); // –ø–æ–¥—Å—Ç–∞–Ω–æ–≤–∫–∞ –≤ —Å–æ–æ–±—â–µ–Ω–∏–µ email-–∞–¥—Ä–µ—Å–∞
        show_msg('auth_msg', msg, 1); // –≤—ã–≤–æ–¥–∏–º —Ç–µ–∫—Å—Ç —Å–æ —Å—Å—ã–ª–∫–æ–π –Ω–∞ –æ—Ç–ø—Ä–∞–≤–∫—É –∑–∞–ø—Ä–æ—Å–∞ –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏—è
        $('#auth_msg_b').html(uimsg['sendmeletter']);
        $('.linkconfirm').attr('href', ajax_url['quick'] + '?addgrp=' + arg['addgrp'] + '&email=' + arg['email'] + '&byemail=1');
        $('#lftrtypeauth').hide(); // —Å–∫—Ä—ã–≤–∞–µ–º –≤—ã–±–æ—Ä —Å–ø–æ—Å–æ–±–∞ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏
        $('.linkconfirm').click( //–∑–∞–ø—Ä–æ—Å –Ω–∞ –ø–æ–ª—É—á–µ–Ω–∏–µ –ø–∏—Å—å–º–∞ —Å–æ —Å—Å—ã–ª–∫–æ–π –¥–ª—è –ø–æ–¥–ø–∏—Å–∫–∏
            function () {
                var h = arg;
                h['byemail'] = 1;
                var data = h2q(h);
    ...
    $('#confirmlaterFormBut').click(function () { // –æ—Ç–ª–æ–∂–µ–Ω–Ω—ã–π –≤–≤–æ–¥ –∫–æ–¥–∞ –ø–æ–¥—Ç–≤–µ—Ä–∂–¥–µ–Ω–∏—è - –ø–µ—Ä–µ—Ö–æ–¥ –∫ –∞–Ω–∫–µ—Ç–µ
        showqForm(); // –∞–Ω–∫–µ—Ç–∞
    });

    $('#quickFormSubBut').click( // –±—ã—Å—Ç—Ä–∞—è –ø–æ–¥–ø–∏—Å–∫–∞
        function () {
            ...
            if (ta == 'openid') {
                ...
                userinfo['quick'] = 1;
                var listgid; // –∫–æ–¥ —Ä–∞—Å—Å—ã–ª–∫–∏
                var pb = $('#subscriberu_email_pb');
                pb.html(ui['pbimg']);
                pb.show();

                if (typeof(aobj) != "undefined") {
                    if (aobj.hasClass('ssbtn')) { // –≤—ã–±–æ—Ä–æ—á–Ω–∞—è –ø–æ–¥–ø–∏—Å–∫–∞ --
                        var h = {};
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    ...
                                    if (res.match(/^member\/quick\/(add|new)$/)) {
                                        var what = RegExp.$1
                                        if (what == 'add') { // –∞–¥—Ä–µ—Å —É–∂–µ –ø–æ–¥–ø–∏—Å–∞–Ω, –ø—Ä–µ–¥–ª–∞–≥–∞–µ–º –≤–∞—Ä–∏–∞–Ω—Ç—ã
                                            showloginForm(); // –≤–≤–µ—Å—Ç–∏ –ø–∞—Ä–æ–ª—å
                                            $('#lf_tapanel').hide();
                                            $('#loginFormCpt').css('margin-left', '3em');
                                            $('#loginFormBut').val(subscriberu_but_cpt['subscribe']);
                                            $('#credential_0').attr('value', $('#quickFormid').val());
                                            $('#credential_0').click(); // –≤–∫–ª—é—á–∞–µ–º —Å—Å—ã–ª–∫—É –Ω–∞–ø–æ–º–∏–Ω–∞–Ω–∏—è
                                        } else if (what == 'new') {
                                            eventstat('reg');
                                            userinfo['needconfirm'] == 1 ? showconfirmForm() : showqForm();
                                        }
                ...
                if (userinfo['vk']['event'].match(/^login|xz$/)) {
                    ...
                    if ($('#subscriberu_anksyncq').attr('checked') == true) { // –≤—ã–±—Ä–∞–Ω–æ –æ–±–Ω–æ–≤–ª–µ–Ω–∏–µ –∞–Ω–∫–µ—Ç—ã –¥–∞–Ω–Ω—ã–º–∏ –∏–∑ vk
                ...
                if (userinfo['mru']['event'].match(/^login|xz$/)) {
                    ...
                    if ($('#subscriberu_anksyncqmr').attr('checked') == true) { // –≤—ã–±—Ä–∞–Ω–æ –æ–±–Ω–æ–≤–ª–µ–Ω–∏–µ –∞–Ω–∫–µ—Ç—ã –¥–∞–Ω–Ω—ã–º–∏ –∏–∑ Mail.ru
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        if (res.match(/^member\/quick\/(add|new)$/)) {
                            var what = RegExp.$1
                            if (what == 'add') { // –∞–¥—Ä–µ—Å —É–∂–µ –ø–æ–¥–ø–∏—Å–∞–Ω, –ø—Ä–µ–¥–ª–∞–≥–∞–µ–º –≤–∞—Ä–∏–∞–Ω—Ç—ã
                                showpwdform(h); // —Ñ–æ—Ä–º–∞ –¥–ª—è –≤–≤–æ–¥–∞ –ø–∞—Ä–æ–ª—è
                            } else if (what == 'new') {
                                eventstat('reg');
                                userinfo['needconfirm'] == 1 ? showconfirmForm() : showqForm();
                            }
                        } else { // –Ω–∞–ø—Ä–∏–º–µ—Ä, —É–∂–µ –ø–æ–¥–ø–∏—Å–∞–Ω - member\/quick\/already
    ...
    // –æ–±—Ä–∞–±–æ—Ç—á–∏–∫ –Ω–∞–ø–æ–º–∏–Ω–∞–Ω–∏—è –ø–∞—Ä–æ–ª—è
    $('#linkrecall').click(
        function () {
            if ($('#credential_0').val() != '') {
    ...
    // –ø—Ä–æ–≤–µ—Ä–∫–∞ –∏ (–≤ —Å–ª—É—á–∞–µ —É—Å–ø–µ—à–Ω–æ–≥–æ —Ä–µ–∑—É–ª—å—Ç–∞—Ç–∞) –¥–æ–±–∞–≤–ª–µ–Ω–∏–µ –Ω–∏–∫–∞ –≤ –ø—Ä–æ—Ñ–∏–ª—å
    $('#nickFormBut').click(function (e) {
        if (e.button == 0 || !$(this).hasClass('subscriberu_nonick')) { // —Ç–æ–ª—å–∫–æ –¥–ª—è –ª–µ–≤–æ–π –∫–Ω–æ–ø–∫–∏ –º—ã—à–∏
    ...
    $('.subscriberu_nonick').live('click', function () { // –ø–æ–ø—ã—Ç–∫–∞ –¥–æ–±–∞–≤–∏—Ç—å –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π –∏–ª–∏ –æ—Ç–∫—Ä—ã—Ç—å –ø–æ—Å—Ç –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª–µ–º —Å –Ω–µ—É–∫–∞–∑–∞–Ω–Ω—ã–º –Ω–∏–∫–æ–º
        aobj = $(this);
        shownickForm();
        return false;
    });
    ...
    $('.subscriberu_check_reg').live("click", function () {
        var i = $(this);
        if (!i.hasClass('subscriberu_unknown')) { // –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –∏–∑–≤–µ—Å—Ç–µ–Ω
    ...
    // ank - —Ä–∞—Å–∫—Ä—ã–≤–∞—é—â–∏–µ—Å—è –±–∞–Ω–Ω–µ—Ä—ã
    ...
    // —Å—Å—ã–ª–∫–∞ –≥—Ä—É–ø–ø—ã: –ø—Ä–∏—Å–æ–µ–¥–∏–Ω–µ–Ω–∏–µ/–≤—ã—Ö–æ–¥
...
// —É–Ω–∏–≤–µ—Ä—Å–∞–ª—å–Ω—ã–π –æ–±—Ä–∞–±–æ—Ç—á–∏–∫ –≤—Å–µ—Ö –¥–µ–π—Å—Ç–≤–∏–π –Ω–µ–∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–Ω–Ω–æ–≥–æ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—è - –∑–∞–ø–æ–º–∏–Ω–∞–µ—Ç –æ–±—ä–µ–∫—Ç, –∏ –æ—Ç–∫–ª–∞–¥—ã–≤–∞–µ—Ç –≤—ã–ø–æ–ª–Ω–µ–Ω–∏–µ –µ–≥–æ –¥–µ–π—Å—Ç–≤–∏—è –¥–æ –∞–≤—Ç–æ—Ä–∏–∑–∞—Ü–∏–∏
// GiN hands: –Ω–µ, –Ω–µ —É–Ω–∏–≤–µ—Ä—Å–∞–ª—å–Ω—ã–π :( —Ç–∞–º –Ω–∏–∂–µ –µ—â–µ –µ—Å—Ç—å –æ–¥–∏–Ω –¥–ª—è –ø–æ–¥–ø–∏—Å–∫–∏ - —Ç–∞–∫ –æ–Ω–∏ –æ–±–∞ –∏ —Å—Ä–∞–±–∞—Ç—ã–≤–∞—é—Ç.
    $('.subscriberu_unknown').live("click", function (e) {
        ...
        /* if (e.button==0 || userinfo['authorized']==1)
         { // —Ç–æ–ª—å–∫–æ –¥–ª—è –ª–µ–≤–æ–π –∫–Ω–æ–ø–∫–∏ –º—ã—à–∏
         aobj = $(this);
         if (aobj.hasClass('subscriberu_unknown'))
         { // —ç—Ç–æ —É—Å–ª–æ–≤–∏–µ –Ω—É–∂–Ω–æ –∏–∑-–∑–∞ –¥–∏–Ω–∞–º–∏—á–µ—Å–∫–æ–≥–æ –ø–µ—Ä–µ–∫–ª—é—á–µ–Ω–∏—è –∫–ª–∞—Å—Å–æ–≤
         ...
         if (aobj.attr('id').match(/^add_comment_(\d+?)$/)){ // –µ—Å–ª–∏ id –∑–∞–¥–∞–Ω
         var id = RegExp.$1;
         $.cookie('Subscribe::Digest_commentid', id, {expires: 7, path: '/'}); // –∑–∞–ø–∏—Å—ã–≤–∞–µ–º –µ–≥–æ –≤ –∫—É–∫—É, —á—Ç–æ–±—ã –ø–æ—Ç–æ–º —Å–ø–æ–∑–∏—Ü–∏–æ–Ω–∏—Ä–æ–≤–∞—Ç—å—Å—è
         }
         }
         }
    ...
    $('a.subscriberu_group_join').live("click", function (e) {
        ...
        if (e.button == 0 || userinfo['authorized'] == 1) {// —Ç–æ–ª—å–∫–æ –¥–ª—è –ª–µ–≤–æ–π –∫–Ω–æ–ø–∫–∏ –º—ã—à–∏
            var i = $(this);
            if (i.hasClass('subscriberu_unknown')) {//–Ω–µ–∞–≤—Ç–æ—Ä–∏–∑–∏—Ä–æ–≤–∞–Ω–Ω—ã–π –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å, –ø–æ–∫–∞–∑—ã–≤–∞–µ–º —Ñ–æ—Ä–º—É –ª–æ–≥–∏–Ω–∞/—Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
                aobj = $(this);
                showloginForm();
                return;
            }
            else {//–ø–æ–ª—å–∑–æ–≤–∞–µ—Ç–ª—å –∏–∑–≤–µ—Å—Ç–µ–Ω
    ...
    $('a.subscriberu_subscribe').live('click', function (e) {//–ø–æ–¥–ø–∏—Å–∫–∞ –Ω–∞ —Ä–∞—Å—Å—ã–ª–∫—É
        ...
        if (e.button == 0 || userinfo['authorized'] == 1) { // —Ç–æ–ª—å–∫–æ –¥–ª—è –ª–µ–≤–æ–π –∫–Ω–æ–ø–∫–∏ –º—ã—à–∏
            ...
            if (i.hasClass('subscriberu_unknown')) {//–Ω–µ–∞–≤—Ç–æ—Ä–∏–∑–∏—Ä–æ–≤–∞–Ω–Ω—ã–π –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å, –ø–æ–∫–∞–∑—ã–≤–∞–µ–º —Ñ–æ—Ä–º—É –ª–æ–≥–∏–Ω–∞/—Ä–µ–≥–∏—Å—Ç—Ä–∞—Ü–∏–∏
            ...
            else { // –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –∏–∑–≤–µ—Å—Ç–µ–Ω
                ...
                h['js'] = 1;
                h['action'] = 'update';
                if (sub_action) {//–æ—Ç—á–µ–≥–æ–∂–µ –æ—Ç—á–µ–≥–æ–∂–µ –æ—Ç—á–µ–≥–æ–∂–µ –Ω–µ—Ç—É —É –Ω–∞—Å –ø—Ä–∏–∑–Ω–∞–∫–∞ —á–µ —Å–æ–±—Å—Ç–≤–µ–Ω–Ω–æ –¥–µ–ª–∞–µ–º?
                    h[sub_action] = h['grp'];
                }
                var redirect = '';
                var reload = 0;
                ...
                $.ajax(
                    { // –≤—ã–ø–æ–ª–Ω—è–µ–º –∑–∞–ø—Ä–æ—Å –Ω–∞ –ø–æ–¥–ø–∏—Å–∫—É
                        'type': 'POST',
    ...
    // –ø–æ–¥—Å–∫–∞–∑–∫–∏ -–¥–ª—è —Ç–æ–ª—å–∫–æ-—á—Ç–æ –≤—Å—Ç—É–ø–∏–≤—à–µ–≥–æ –≤ –≥—Ä—É–ø–ø—É,
        ...
        if (e.button == 0 || userinfo['authorized'] == 1) {
            ...
            if (!i.hasClass('subscriberu_unknown')) { // –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –∏–∑–≤–µ—Å—Ç–µ–Ω
                ...
                if (href.match(/what=(.+?)\&type=(.+?)\&content=(.+?)$/)) {
                    ...
                    var redirect = '';
                    var reload = 0;
                    if (userinfo['authorized'] == 1) {// –µ—Å–ª–∏ –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å –∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–ª—Å—è –∏–ª–∏ –∑–∞—Ä–µ–≥–∏—Å—Ç—Ä–∏—Ä–æ–≤–∞–ª—Å—è
...
// —Å–º–µ–Ω–∞ –∏–∫–æ–Ω–∫–∏ —Å—Å—ã–ª–∫–∏ –¥–æ–±–∞–≤–ª–µ–Ω–∏—è –≤ –∏–∑–±—Ä–∞–Ω–Ω–æ–µ
...
// —Å–º–µ–Ω–∞ –∞–Ω–∫–æ—Ä–∞ —Å—Å—ã–ª–∫–∏ –∏–∑ –∏–∑–±—Ä–∞–Ω–Ω–æ–≥–æ
    ...
    $('div.subscriberu_fbbox').live("mouseover",
        function () {
            ...
            /*
             ...
             if (obj.length){      // –ø–æ–∑–∏—Ü–∏–æ–Ω–∏—Ä–æ–≤–∞–Ω–∏–µ –±–ª–æ–∫–∞ –≤–Ω—É—Ç—Ä–∏ —Å—Ç—Ä–∞–Ω–∏—Ü—ã, –ø–ª—è—Å–∫–∏ —Å –±—É–±–Ω–æ–º
             ...
             // –∞–≤—Ç–æ—Ä—Å–∫–æ–µ –æ–∫–æ—à–∫–æ –¥–ª—è firefox, –≤–Ω—É—Ç—Ä–∏ –±–ª–æ–∫–∞ "div.act"
             ...
             } else { // –æ—Å—Ç–∞–ª—å–Ω–æ–µ –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–µ–º –ø–æ –≤–µ—Ä—Ç–∏–∫–∞–ª–∏
             if (ts < $(this).children('div:first').height() && t > ts){
             $(this).children('div:first').css("top", -$(this).children('div:first').height() + ts - gap);
             } else {
...
// –æ–±—Ä–∞–±–æ—Ç–∫–∞ –¥–æ–±–∞–≤–ª–µ–Ω–∏—è –æ–±—ä–µ–∫—Ç–∞ –≤ –∏–∑–±—Ä–∞–Ω–Ω–æ–µ
    function parse_love_res(data, farg) {
        ...
        if (res == 1) {
            ...
            i.removeClass('subscriberu_load'); // –∑–∞–≥—Ä—É–∑–∫–∞ –≤—ã–ø–æ–ª–Ω–µ–Ω–∞, –≤–æ–∑–≤—Ä–∞—â–∞–µ–º —ç–ª–µ–º–µ–Ω—Ç—É –æ–±—ã—á–Ω–æ–µ –ø–æ–≤–µ–¥–µ–Ω–∏–µ
            ...
            // —É—Å—Ç–∞–Ω–æ–≤–∫–∞ –∞–Ω–∫–æ—Ä–æ–≤
            if (data == 'add') {
                if (v.html() != '') v.html(anchor['a']);  //–í –∏–∑–±—Ä–∞–Ω–Ω–æ–º
                i.addClass(aclass['a']);
                i.removeClass(aclass['b']);
                i.attr('href', i.attr('href').replace('=add', '=del'));
                i.css('color', "#ffffff");
            } else if (data == 'del') {
                if (v.html() != '') v.html(anchor['b']); //–í –∏–∑–±—Ä–∞–Ω–Ω–æ–µ
                i.addClass(aclass['b']);
...
// –æ–±—Ä–∞–±–æ—Ç–∫–∞ –¥–æ–±–∞–≤–ª–µ–Ω–∏—è –ø–æ–¥–ø–∏—Å–∫–∏ 
    function parse_sub_res(res, farg) {
        ...
        var title;
        if (info[0] == 'member/update/done') { // —É—Å—Ç–∞–Ω–æ–≤–∫–∞ –∞–Ω–∫–æ—Ä–æ–≤
            // sub - —è –ø–æ–¥–ø–∏—Å–∞–Ω
            if (info[1] == 'sub') { // –ø–æ–¥–ø–∏—Å–∞–ª—Å—è
                title = subscriberu_anchor['subscriberu_subscribe']['sub'];
                $('.' + lid).attr('href', $('.' + lid).attr('href').replace('/sub?', '/unsub?'));
            }
            else if (info[1] == 'unsub') { // –æ—Ç–ø–∏—Å–∞–ª—Å—è
                if (lid.match(/^l(\d+?)$/)) {
                    var fid = '#f' + RegExp.$1;
                    if ($(fid).length) { // –µ—Å–ª–∏ –µ—Å—Ç—å —Ñ–æ—Ä–º–∞, –≤—ã–∫–ª—é—á–∞–µ–º –∑–Ω–∞—á–µ–Ω–∏—è –≤—ã–±–æ—Ä–æ—á–Ω–æ–π –ø–æ–¥–ø–∏—Å–∫–∏
    ...
    $('.subscriberu_category').each(function () {
        ...
        $(this).find('p.minimize').click(
            function () {
                ...
                $(this).parents('.category').addClass('subscriberu_hidden'); // –∫–∞—Ç–µ–≥–æ—Ä–∏—è —Å–∫—Ä—ã—Ç–∞

                var a = new Array();
                a = $('div.subscriberu_category:not(.subscriberu_hidden)'); // –≤—ã–±–∏—Ä–∞–µ–º –Ω–µ—Å–∫—Ä—ã—Ç—ã–µ –∫–∞—Ç–µ–≥–æ—Ä–∏–∏
                if (a.length == 0) $('#issue_menu').hide(); // –µ—Å–ª–∏ —Ç–∞–∫–∏—Ö –Ω–µ—Ç, —Å–∫—Ä—ã–≤–∞–µ–º –∏ –∑–∞–≥–æ–ª–æ–≤–æ–∫
                ...
                if (cookie_check) { // –∫—É–∫–∏ –Ω–µ—Ç, –∑–Ω–∞—á–∏—Ç –∏ –∫–∞—Ç–µ–≥–æ—Ä–∏–∏ –≤ —Å–ø–∏—Å–∫–µ —Å–≤–µ—Ä–Ω—É—Ç—ã—Ö –Ω–µ—Ç
                    ...
                    $('.maximize ul').prepend(content).find('li').eq(0)
                        ...
                        function () {
                            ...
                            ;
                            $.cookie('Subscribe::Digest_foldedid', tmp, {expires: 7, path: '/'});
                            if (tmp == '') $('.maximize p.title').hide(); // –µ—Å–ª–∏ –≤ –∫—É–∫–µ –Ω–µ—Ç –∫–∞—Ç–µ–≥–æ—Ä–∏–π, —Å–∫—Ä—ã–≤–∞–µ–º –∑–∞–≥–æ–ª–æ–≤–æ–∫ —Å–ø–∏—Å–∫–∞
...
// —Ñ–æ—Ä–º—Ä—É–µ—Ç —Å–ø–∏—Å–æ–∫ —Å–≤–µ—Ä–Ω—É—Ç—ã—Ö –∫–∞—Ç–µ–≥–æ—Ä–∏–π
    function rollupcatlist() {
        var cookie = $.cookie('Subscribe::Digest_foldedid'); // —Å–≤–µ—Ä–Ω—É—Ç—ã—Ö –∫–∞—Ç–µ–≥–æ—Ä–∏–π –≤ –∫—É–∫–µ –Ω–µ—Ç
        if (cookie == '' || cookie == null) return false;
        $.cookie('Subscribe::Digest_foldedid', cookie, {expires: 7, path: '/'});
        $('.maximize p.title').show(); // –ø–æ–∫–∞–∑—ã–≤–∞–µ–º –∑–∞–≥–æ–ª–æ–≤–æ–∫ —Å–≤–µ—Ä–Ω—É—Ç—ã—Ö –∫–∞—Ç–µ–≥–æ—Ä–∏–π
        cookie = cookie.split(/(?:\s)/);
        for (var i in cookie) {
            var item = $('#' + cookie[i]);
            ...
            $('.maximize ul').prepend(content).find('li').eq(0)
                ...
                function () {
                    ...
                    $("#content .category#" + cid).show();
                    var to = $(".category#" + cid).offset().top;
                    $('html,body').animate({scrollTop: to}, "fast"); // –ø–æ–∑–∏—Ü–∏–æ–Ω–∏—Ä–æ–≤–∞–Ω–∏–µ –ø–æ id –Ω–∞ –Ω—É–∂–Ω–æ–π —Ä—É–±—Ä–∏–∫–µ
...
// —Å—Ç–∞—Ç–∏—Å—Ç–∏–∫–∞ –≥—É–≥–ª–∞
    ...
    if (isindex) rollupcatlist(); // –µ—Å–ª–∏ —Å—Ç—Ä–∞–Ω–∏—Ü–∞ –∏–Ω–¥–µ–∫—Å–Ω–∞—è, –≤—ã–≤–æ–¥–∏–º —Å–ø–∏—Å–æ–∫ –∫–∞—Ç–µ–≥–æ—Ä–∏–π
...
function group_unsubscribe_member(slug) {//–æ—Ç–ø–∏—Å–∞—Ç—Å—è –æ—Ç –≥—Ä—É–ø–ø—ã
    $.get('/group/' + slug + '/unsubscribe/');
    $('#group_unsubscribe_member').hide();
    $('#group_subscribe_member').show();
};

function group_subscribe_member(slug) {//–ø–æ–¥–ø–∏—Å–∞—Ç—Å—è
    $.get('/group/' + slug + '/subscribe/');
    $('#group_subscribe_member').hide();
    $('#group_unsubscribe_member').show();
};

function group_member_notify(obj) {//–∏–∑–º–µ–Ω–∏—Ç—å —Å–ø–æ—Å–æ–± —É–≤–µ–¥–æ–º–ª–µ–Ω–∏—è
...
/* old +/- for group topic
 ...
 voteD.css({'overflow':'hidden','height':'13px'}); // –ü–æ–¥–≥–æ—Ç–æ–≤–∫–∞ –∫ —Å–∫—Ä–æ–ª—É
 ...
 voteD.animate({ 'overflow': 'visible', 'scrollTop': '0px' }); // –§–∏–∫—Å –¥–ª—è FF 3.0 - 4.0
 voteD.html(newVoteStr); // –ó–∞–º–µ–Ω–∞ html –Ω–∞ –æ–±—ã—á–Ω—ã–π —Ç–µ–∫—Å—Ç
 });

 $('.ev-VoteUp, .ev-VoteDown').css('visibility','hidden');
 $.getJSON(url, {js: 1}); // –ó–∞–ø—Ä–æ—Å –Ω–∞ –∏–∑–º–µ–Ω–µ–Ω–∏–µ —Å—á–µ—Ç—á–∏–∫–∞
...
/* don't used */
    ...
    function changeTarget(){
        if($('.topicentry #usertext').length){
            ...
            links.each(function(){
                ...
                if(link.search(regexpSub)<0 && link.search(regexpHttp)>-1) {    // Œ≈‘ ”Ãœ◊ subscribe.ru … ≈”‘ÿ http
    ...
    /* ”–Ã¡ ”≈“ Ã¡‘≈Œ‘Œœ-ƒ’–Ã…√…“œ◊¡ŒŒœ«œ ‹Ã≈Õ≈Œ‘¡ «≈ŒœÕ¡ ∆œ“ÕŸ */
    function splicer() {
        ...
        if($.ui && $.ui.autocomplete) {
            ...
            $.widget("custom.combobox", {
                ...
                _removeIfInvalid: function (event, ui) {
                    ...
                    if (this.input.val()) {
                        this.input
                            .attr("title", value + " Œ≈ ”œœ‘◊≈‘”‘◊’≈‘ Œ… œƒŒœÕ’ …⁄ “≈«…œŒœ◊")
                            .tooltip("open");
                    }
...
// ! calendar UI
    ...
    /*if ($('.calendar').size() != 0 || $('.calendarInput').size() != 0) {
     ...
     nextText: 'ÛÃ≈ƒ&#x3e;',
     currentText: 'Û≈«œƒŒ—',
     monthNames: ['ÒŒ◊¡“ÿ','Ê≈◊“¡Ãÿ','Ì¡“‘','·–“≈Ãÿ','Ì¡ ','È¿Œÿ','È¿Ãÿ','·◊«’”‘','Û≈Œ‘—¬“ÿ','ÔÀ‘—¬“ÿ','Óœ—¬“ÿ','‰≈À¡¬“ÿ'],
     monthNamesShort: ['ÒŒ◊','Ê≈◊','Ì¡“','·–“','Ì¡ ','È¿Œ','È¿Ã','·◊«','Û≈Œ','ÔÀ‘','Óœ—','‰≈À'],
     dayNames: ['◊œ”À“≈”≈Œÿ≈','–œŒ≈ƒ≈ÃÿŒ…À','◊‘œ“Œ…À','”“≈ƒ¡','ﬁ≈‘◊≈“«','–—‘Œ…√¡','”’¬¬œ‘¡'],
     dayNamesShort: */
    /*['◊”À','–Œƒ','◊‘“','”“ƒ','ﬁ‘◊','–‘Œ','”¬‘']*/
    /*['˜”','Œ','˜‘','Û“','˛‘','‘','Û¬'],
     dayNamesMin: ['˜”','Œ','˜‘','Û“','˛‘','‘','Û¬'],
    ...
    // œ‘Õ≈ﬁ¡≈Õ\”À“Ÿ◊¡≈Õ –’ŒÀ‘Ÿ ¡ŒÀ≈‘Ÿ ◊ ⁄¡◊…”…Õœ”‘… œ‘ ◊œ⁄“¡”‘¡
    function childUser(year){
        ...
        if(userAge < 16) {
            ...
            $("div.user_a_18 select option[value=1]").attr('selected','selected');   // œ‘Õ≈ﬁ¡≈Õ 1 “≈¬≈ŒÀ¡ ◊ ”≈Õÿ≈
            if($(".continue-learn").prop("checked"))  {
                $("div.user_a_22 select option").attr('selected',false);
                $("div.user_a_22 select option[VALUE=j]").attr('selected','selected');   // ”œ√.-–œÃœ÷≈Œ…≈ - ’ﬁ¡›… ”—
            }
        } else {
...
// ! copy from member/anketa/join/target - autocomplete
    ...
    availablePlaces =
        [
            ["Ìœ”À◊¡", "≈‘≈“¬’“«", "Û¡ŒÀ‘-≈‘≈“¬’“«", "Û≈◊¡”‘œ–œÃÿ", "Û…Õ∆≈“œ–œÃÿ", "Î“ŸÕ", "·¬¡⁄¡", "·¬¡À¡Œ", "·¬ƒ’Ã…Œœ", "·¬…Œ”À", "·«“Ÿ⁄", "·ƒŸ«≈ ”À", "·ƒŸ«≈—", "·⁄Œ¡À¡≈◊œ", "·⁄œ◊", "·À-‰œ◊’“¡À", "·À”¡ ", "·Ã¡«…“", "·Ã¡–¡≈◊”À", "·Ã¡‘Ÿ“ÿ", "·Ãƒ¡Œ", "·Ã≈ ”À", "·Ã≈À”¡Œƒ“œ◊", "·Ã≈À”¡Œƒ“œ◊”À", "·Ã≈À”¡Œƒ“œ◊”À-Û¡»¡Ã…Œ”À… ", "·Ã≈À”≈≈◊À¡", "·Ã≈À”…Œ", "·Ã⁄¡Õ¡ ", "·Ã‘¡ ", "·Ã‘¡ ”À…  À“¡ ", "·ÃÿÕ≈‘ÿ≈◊”À", "·Õ’“”À", "·Õ’“”À¡— œ¬Ã¡”‘ÿ", "·Œ¡ƒŸ“ÿ", "·Œ¡–¡", "·Œ«¡“”À", "·Œƒ“≈¡–œÃÿ", "·Œ÷≈“œ-Û’ƒ÷≈Œ”À", "·Œ…◊¡", "·–¡‘…‘Ÿ", "·–“≈Ã≈◊À¡", "·–€≈“œŒ”À", "·“¡Õ…Ãÿ", "·“«’Œ", "·“ƒ¡‘œ◊", "·“ƒœŒ", "·“⁄¡Õ¡”", "·“À¡ƒ¡À", "·“Õ¡◊…“", "·“”≈Œÿ≈◊", "·“”À", "·“�
�Õ»œ◊œ", "˛≈“≈–¡Œœ◊œ", "˛≈“≈–œ◊≈√", "˛≈“À≈””À", "˛≈“Œœ«œÃœ◊À¡", "˛≈“Œœ«œ“”À", "˛≈“Œ’€À¡", "˛≈“Œ—»œ◊”À", "˛≈»œ◊", "˛≈ﬁŒ—", "˛…”‘œ–œÃÿ", "˛…‘¡", "˛À¡Ãœ◊”À", "˛’◊¡€…—", "˛’ƒœ◊œ", "˛’Àœ‘”À…  ¡◊‘. œÀ“.", "˛’ÃŸÕ", "˛’”œ◊œ ", "˛’»ÃœÕ¡", "˛£“Õœ⁄", "˚¡«œŒ¡“", "˚¡ƒ“…Œ”À", "˚¡Ã…", "˚¡“Ÿ–œ◊œ", "˚¡“ÿ—", "˚¡‘’“¡", "˚¡»‘£“”À", "˚¡»’Œÿ—", "˚¡√À", "˚≈¬≈À…Œœ", "˚≈Ã≈»œ◊", "˚≈ŒÀ’“”À", "˚…ÃÀ¡", "˚…Õ¡Œœ◊”À", "˚Ã…””≈Ãÿ¬’“«", "˚’Õ≈“Ã—", "˚’Õ…»¡", "˚’—", "˝≈“¬…ŒÀ¡", "˝…«“Ÿ", "˝’ﬁÿ≈", "˝£À…Œœ", "˝£ÃÀœ◊œ", "¸Ã≈À‘“œ«œ“”À", "¸Ã≈À‘“œ”‘¡Ãÿ", "¸Ã≈À‘“œ’«Ã…", "¸Ã…”‘¡", "¸Œ«≈Ãÿ”", "¸“‘…Ãÿ", "‡¬…Ã≈ ŒŸ ", "‡«œ“”À", "‡÷¡", "‡÷Œœ-Û¡»¡Ã…Œ”À", "‡÷Œœ-Û’»œÀ’Õ”À", "‡÷Œœ’“¡Ãÿ”À", "‡“«¡", "‡“ÿ≈◊-œÃÿ”À… ", "‡“ÿ≈◊≈√", "‡“¿⁄¡Œÿ", "‡»Œœ◊", "Òƒ“…Œ", "ÒÀ’‘…—", "ÒÀ’‘”À", "ÒÃ’‘œ“œ◊”À", "ÒÕ¡Ãœ-Ó≈Œ≈√À…  ¡◊‘. œÀ“.", "ÒŒ¡’Ã", "Ò“¡Œ”À", "Ò“œ◊œ≈", "Ò“œ”Ã¡◊Ãÿ", "Ò“œ”Ã¡◊”À¡— œ¬Ã¡”‘ÿ", "Ò“√≈◊œ", "Ò”Œœ«œ“”À", "Ò”ŒŸ ", "Ò»“œÕ¡",
                'Úœ””…—',
                '·⁄≈“¬¡ ƒ÷¡Œ',
                '·“Õ≈Œ…—',
                '‚≈Ã¡“’”ÿ',
...
$(document).ready(function(){
    ...
    $("#id_text.feedback_text-spam").DefaultValue("–ü–æ—á–µ–º—É –≤—ã —Å—á–∏—Ç–∞–µ—Ç–µ —ç—Ç–æ —Å–ø–∞–º–æ–º?");
    $("#id_email.members_invite_emails").DefaultValue("–µ—Å–ª–∏ –Ω–µ—Å–∫–æ–ª—å–∫–æ, —Ç–æ —á–µ—Ä–µ–∑ –∑–∞–ø—è—Ç—É—é");
    $('.nonregisteredpart #id_email').DefaultValue('@');
    $('#groupsearchq').DefaultValue('–ü–æ–∏—Å–∫ –ø–æ –≥—Ä—É–ø–ø–µ');
    checkboxActive();
});
...
function reinit_mce(self) {
    ...
    if (form_header.length) {
        $('span', form_header).html('–û—Ç–≤–µ—Ç –Ω–∞ –∫–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π');
...
function init_group_edit_behavior() {
    ...
    function loadCats(target, parent) {
        if (parent) {
            target.html("<option value=''></option><option value=''>–ò–¥–µ—Ç –∑–∞–≥—Ä—É–∑–∫–∞ –¥–∞–Ω–Ω—ã—Ö...</option>");
    ...
    cat = {
        "Hi-Tech": "hitech",
        "–ê–≤—Ç–æ–º–æ–±–∏–ª–∏": "auto",
        "–ë–∏–∑–Ω–µ—Å –∏ –∫–∞—Ä—å–µ—Ä–∞": "business",
        "–î–æ–º –∏ —Å–µ–º—å—è": "home",
        "–ö–æ–º–ø—å—é—Ç–µ—Ä—ã –∏ –∏–Ω—Ç–µ—Ä–Ω–µ—Ç": "comp",
        "–ö—É–ª—å—Ç—É—Ä–∞, —Å—Ç–∏–ª—å –∂–∏–∑–Ω–∏": "culture",
        "–ú–∏—Ä –∂–µ–Ω—â–∏–Ω—ã": "woman",
        "–ù–æ–≤–æ—Å—Ç–∏ –∏ –°–ú–ò": "media",
        "–û–±—â–µ—Å—Ç–≤–æ": "socio",
        "–ü—Ä–æ–≥–Ω–æ–∑ –ø–æ–≥–æ–¥—ã": "weather",
        "–°–ø–æ—Ä—Ç": "sport",
        "–°—Ç—Ä–∞–Ω—ã –∏ —Ä–µ–≥–∏–æ–Ω—ã": "country",
        "–¢—É—Ä–∏–∑–º": "travel",
        "–≠–∫–æ–Ω–æ–º–∏–∫–∞ –∏ —Ñ–∏–Ω–∞–Ω—Å—ã": "economics"
    },
        hitech = {
            "–í–∏–¥–µ–æ –∏ –∑–≤—É–∫": "hitech.video",
            "–ì–∞–¥–∂–µ—Ç—ã": "hitech.gadj",
            "–ö–æ–Ω—Ü–µ–ø—Ç—ã": "hitech.kon",
            "–ù–æ–≤–æ—Å—Ç–∏": "hitech.news",
            "–°–≤—è–∑—å": "hitech.connection"
        },
        hitech_connection = {
            "–ú–æ–±–∏–ª—å–Ω–∞—è —Å–≤—è–∑—å": "hitech.connection.mobile"
        },
        hitech_video,hitech_gadj,hitech_kon,hitech_news,
        auto = {
            "–ê–≤—Ç–æ–±–∏–∑–Ω–µ—Å": "auto.biz",
            "–ê–≤—Ç–æ–Ω–æ–≤–æ—Å—Ç–∏": "auto.worldnews",
            "–î–æ—Ä–æ–≥–∏": "auto.roads",
            "–ù–æ–≤–∏–Ω–∫–∏": "auto.newness",
            "–û–±–∑–æ—Ä—ã": "auto.review",
            "–ü–æ–ª–µ–∑–Ω—ã–µ —Å–æ–≤–µ—Ç—ã": "auto.advice",
            "–°–ú–ò –æ–± –∞–≤—Ç–æ–º–æ–±–∏–ª—è—Ö": "auto.smi",
            "–°–∏–≥–Ω–∞–ª–∏–∑–∞—Ü–∏–∏": "auto.alarm",
            "–¢–µ—Å—Ç—ã": "auto.test",
            "–¢—é–Ω–∏–Ω–≥": "auto.tuning"
        },
        ...
        business = {
            "–ó–∞–∫–æ–Ω": "business.law",
            "–ö–Ω–∏–≥–∏ –∏ –ü–û": "business.book",
            "–ú–∞—Ä–∫–µ—Ç–∏–Ω–≥": "business.marketing",
            "–ù–µ–¥–≤–∏–∂–∏–º–æ—Å—Ç—å": "business.realty",
            "–û–±—Ä–∞–∑–æ–≤–∞–Ω–∏–µ": "business.edu",
            "–ü–æ–∏—Å–∫ —Ä–∞–±–æ—Ç—ã": "business.job",
            "–ü—Ä–æ—Ñ–µ—Å—Å–∏–æ–Ω–∞–ª–∏–∑–º": "business.school",
            "–†–µ–∫–ª–∞–º–∞": "business.ad",
            "–¢–µ—Ö–Ω–æ–ª–æ–≥–∏–∏ –¥–ª—è –±–∏–∑–Ω–µ—Å–∞": "business.tech"
        },
        business_law,business_book,business_edu,business_ad,business_tech,
        business_marketing = {
            "–î–∏—Ä–µ–∫—Ç-–º–∞—Ä–∫–µ—Ç–∏–Ω–≥": "business.marketing.direct",
            "–ò–Ω—Ç–µ—Ä–Ω–µ—Ç-–º–∞—Ä–∫–µ—Ç–∏–Ω–≥": "business.marketing.internet",
            "–ò—Å—Å–ª–µ–¥–æ–≤–∞–Ω–∏—è": "business.marketing.research"
        },
        business_realty = {
            "–ò–ø–æ—Ç–µ–∫–∞": "business.realty.mortgage",
            "–ù–æ–≤–æ—Å—Ç–∏": "business.realty.realty"
        },
        business_job = {
            "–í–∞–∫–∞–Ω—Å–∏–∏": "business.job.vacancy",
            "–û–±—É—á–µ–Ω–∏–µ": "business.job.education",
            "–†–µ–∑—é–º–µ": "business.job.resume"
        },
        business_school = {
            "–ë–∏–∑–Ω–µ—Å-–æ–±—Ä–∞–∑–æ–≤–∞–Ω–∏–µ": "business.school.edu",
            "–ú–µ–Ω–µ–¥–∂–º–µ–Ω—Ç": "business.school.manage",
            "–£–ø—Ä–∞–≤–ª–µ–Ω–∏–µ –∫–∞—Ä—å–µ—Ä–æ–π": "business.school.career",
            "–£–ø—Ä–∞–≤–ª–µ–Ω–∏–µ –ø–µ—Ä—Å–æ–Ω–∞–ª–æ–º": "business.school.hr"
        },
        home = {
            "–î–µ—Ç–∏": "home.children",
            "–ñ–∏–≤–æ—Ç–Ω—ã–µ": "home.animals",
            "–ó–¥–æ—Ä–æ–≤—å–µ": "home.health",
            "–ò–Ω—Ç–µ—Ä—å–µ—Ä": "home.interior",
            "–ö—É–ª–∏–Ω–∞—Ä–∏—è": "home.cookery",
            "–ü–æ–ª–µ–∑–Ω—ã–µ —Å–æ–≤–µ—Ç—ã": "home.help",
            "–ü—Ä–∏—Ä–æ–¥–∞": "home.nature",
            "–†–µ–º–æ–Ω—Ç": "home.build",
            "–†–æ—Å–∫–æ—à—å": "home.luxury"
        },
        home_children = {
            "–ë–µ—Ä–µ–º–µ–Ω–Ω–æ—Å—Ç—å –∏ —Ä–æ–¥—ã": "home.children.pregnancy",
            "–í–æ—Å–ø–∏—Ç–∞–Ω–∏–µ": "home.children.education",
            "–†–∞–∑–≤–∏—Ç–∏–µ": "home.children.development",
            "–°–æ–≤–µ—Ç—ã —Ä–æ–¥–∏—Ç–µ–ª—è–º": "home.children.advice",
            "–®–∫–æ–ª–∞": "home.children.school"
        },
        home_animals = {
            "–í–µ—Ç–µ—Ä–∏–Ω–∞—Ä–∏—è": "home.animals.veterinary",
            "–ö–æ—à–∫–∏": "home.animals.cat",
            "–ü–æ–ª–µ–∑–Ω—ã–µ —Å–æ–≤–µ—Ç—ã": "home.animals.advice",
            "–°–æ–±–∞–∫–∏": "home.animals.dog",
            "–≠–∫–∑–æ—Ç–∏–∫–∞": "home.animals.exotic"
        },
        home_health = {
            "–î–∏–µ—Ç—ã": "home.health.diets",
            "–î–æ–∫—Ç–æ—Ä –æ—Ç–≤–µ—á–∞–µ—Ç": "home.health.doctor",
            "–õ–µ—á–µ–Ω–∏–µ": "home.health.treatment",
            "–ù–∞—Ä–æ–¥–Ω–∞—è –º–µ–¥–∏—Ü–∏–Ω–∞": "home.health.medicine",
            "–û–±—Ä–∞–∑ –∂–∏–∑–Ω–∏": "home.health.life",
            "–ü—Ä–æ—Ñ–∏–ª–∞–∫—Ç–∏–∫–∞": "home.health.preventive"
        },home_interior,
        home_cookery = {
            "–í—ã–ø–µ—á–∫–∞": "home.cookery.batch",
            "–î–µ—Å–µ—Ä—Ç—ã": "home.cookery.dessert",
            "–ú—è—Å–Ω—ã–µ –±–ª—é–¥–∞": "home.cookery.meat",
            "–ù–∞–ø–∏—Ç–∫–∏": "home.cookery.cocktail",
            "–û–≤–æ—â–Ω—ã–µ –±–ª—é–¥–∞": "home.cookery.vegetable",
            "–ü–æ–ª–µ–∑–Ω—ã–µ —Å–æ–≤–µ—Ç—ã": "home.cookery.advice",
            "–†—ã–±–Ω—ã–µ –±–ª—é–¥–∞": "home.cookery.fish",
            "–°–∞–ª–∞—Ç—ã": "home.cookery.salad",
            "–°—É–ø—ã": "home.cookery.soup"
        },
        home_help = {
            "–ë—ã—Ç–æ–≤–∞—è —Ç–µ—Ö–Ω–∏–∫–∞": "home.help.device",
            "–ü–æ—Ç—Ä–µ–±–∏—Ç–µ–ª—é": "home.help.consume"
        },home_nature,home_build,home_luxury,
        comp = {
            "IT-–∑–∞—â–∏—Ç–∞": "comp.safety",
            "–í–µ–±": "comp.web",
            "–ì—Ä–∞—Ñ–∏–∫–∞ –∏ –¥–∏–∑–∞–π–Ω": "comp.design",
            "–î–æ–∫—É–º–µ–Ω—Ç–∞—Ü–∏—è, –∫–Ω–∏–≥–∏, —Å–ª–æ–≤–∞—Ä–∏": "comp.paper",
            "–ñ–µ–ª–µ–∑–æ": "comp.hard",
            "–ò–≥—Ä—ã": "comp.games",
            "–ò–Ω—Ç–µ—Ä–Ω–µ—Ç": "comp.inet",
            "–ù–æ–≤–∏–Ω–∫–∏": "comp.newness",
            "–ù–æ–≤–æ—Å—Ç–∏": "comp.news",
            "–û–±–∑–æ—Ä—ã": "comp.review",
            "–û–±—É—á–µ–Ω–∏–µ": "comp.edu",
            "–°–æ—Ñ—Ç": "comp.soft",
            "–¢–µ—Å—Ç—ã": "comp.test"
        },
        comp_safety,comp_design,comp_paper,
        comp_web = {
            "–ë–ª–æ–≥–∏ –∏ –ø–µ—Ä—Å–æ–Ω–∞–ª—å–Ω—ã–µ —Å–∞–π—Ç—ã": "comp.web.personal",
            "–ü–æ—Ä—Ç–∞–ª—ã": "comp.web.portal",
            "–°–æ–æ–±—â–µ—Å—Ç–≤–∞": "comp.web.community"
        },
        comp_hard = {
            "–°–µ—Ç–∏ –∏ —Å–≤—è–∑—å": "comp.hard.telecom"
        },comp_games,
        comp_inet = {
            "–í–µ–±-–¥–∏–∑–∞–π–Ω": "comp.inet.design",
            "–í–µ–±-—Å—Ç—Ä–æ–∏—Ç–µ–ª—å—Å—Ç–≤–æ": "comp.inet.webbuild",
            "–û–±–∑–æ—Ä—ã": "comp.inet.review",
            "–ü—Ä–æ–¥–≤–∏–∂–µ–Ω–∏–µ —Å–∞–π—Ç–æ–≤. SEO": "comp.inet.search"
        },comp_newness,
        comp_news = {
            "–ù–æ–≤–æ—Å—Ç–∏ –∏–Ω—Ç–µ—Ä–Ω–µ—Ç–∞": "comp.news.inet",
            "–ù–æ–≤–æ—Å—Ç–∏ –∫–æ–º–ø—å—é—Ç–µ—Ä–Ω—ã—Ö –∏–≥—Ä": "comp.news.games"
        },
        comp_review = {
            "–û–±–∑–æ—Ä—ã –ü–û": "comp.review.soft"
        },
        comp_edu,comp_test,
        comp_soft = {
            "3D –≥—Ä–∞—Ñ–∏–∫–∞": "comp.soft.3d",
            "–ë–∞–∑—ã –¥–∞–Ω–Ω—ã—Ö": "comp.soft.db",
            "–ë–∏–∑–Ω–µ—Å": "comp.soft.biz",
            "–ì—Ä–∞—Ñ–∏—á–µ—Å–∫–∏–µ —Ä–µ–¥–∞–∫—Ç–æ—Ä—ã": "comp.soft.graph",
            "–û–ø–µ—Ä–∞—Ü–∏–æ–Ω–Ω—ã–µ —Å–∏—Å—Ç–µ–º—ã": "comp.soft.os",
            "–ü—Ä–æ–≥—Ä–∞–º–º–∏—Ä–æ–≤–∞–Ω–∏–µ": "comp.soft.prog",
            "–ü—Ä–æ—á–µ–µ": "comp.soft.others",
            "–°–ê–ü–†": "comp.soft.sapr",
            "–¢–µ—Å—Ç–∏—Ä–æ–≤–∞–Ω–∏–µ –ü–û": "comp.soft.testing"
        },
        culture = {
            "Pro Art":"culture.art",
            "–ö–∏–Ω–æ –∏ –¢–í":"culture.kino",
            "–õ–∏—Ç–µ—Ä–∞—Ç—É—Ä–∞": "culture.lit",
            "–ú—É–∑—ã–∫–∞": "culture.music",
            "–ù–æ–≤–æ—Å—Ç–∏": "culture.news",
            "–û—Ç–¥—ã—Ö": "culture.rest",
            "–ü—Å–∏—Ö–æ–ª–æ–≥–∏—è": "culture.psychology",
            "–†–µ–ª–∏–≥–∏—è": "culture.religion",
            "–¢–∞–∏–Ω—Å—Ç–≤–µ–Ω–Ω–æ–µ": "culture.mystery",
            "–§–æ—Ç–æ": "culture.foto",
            "–•–æ–±–±–∏": "culture.hobby",
            "–®–æ—É-–±–∏–∑–Ω–µ—Å": "culture.showbiz"
        },
        culture_religion,culture_foto,culture_hobby,culture_showbiz,
        culture_art = {
            "–ñ–∏–≤–æ–ø–∏—Å—å –∏ –∞—Ä—Ö–∏—Ç–µ–∫—Ç—É—Ä–∞": "culture.art.arch",
            "–ú—É–∑–µ–∏": "culture.art.museum",
            "–¢–∞–Ω—Ü—ã": "culture.art.dance",
            "–¢–µ–∞—Ç—Ä": "culture.art.theatre",
            "–§–æ—Ç–æ–≥—Ä–∞—Ñ–∏—è": "culture.art.photo",
            "–¶–∏—Ä–∫": "culture.art.circus",
            "–Æ–≤–µ–ª–∏—Ä–Ω–æ–µ –∏—Å–∫—É—Å—Å—Ç–≤–æ": "culture.art.jewelry"
        },
        culture_kino = {
            "–ò–Ω—Ç–µ—Ä–≤—å—é": "culture.kino.interview",
            "–ù–æ–≤–æ—Å—Ç–∏": "culture.kino.news",
            "–ü—Ä–µ–º—å–µ—Ä—ã": "culture.kino.premiere",
            "–†–µ—Ü–µ–Ω–∑–∏–∏": "culture.kino.review"
        },
        culture_lit = {
            "–ë–∏–±–ª–∏–æ—Ç–µ–∫–∏": "culture.lit.library",
            "–ì—Ä–∞—Ñ–æ–º–∞–Ω–∏—è": "culture.lit.graph",
            "–î–ª—è –¥–µ—Ç–µ–π": "culture.lit.kids",
            "–ö–Ω–∏–≥–∏": "culture.lit.book",
            "–ù–æ–≤–æ—Å—Ç–∏ –∏ –æ–±–∑–æ—Ä—ã –∫–Ω–∏–∂–Ω–æ–≥–æ —Ä—ã–Ω–∫–∞": "culture.lit.news",
            "–û–±–æ–∑—Ä–µ–Ω–∏—è": "culture.lit.review",
            "–ü–∏—Å–∞—Ç–µ–ª–∏. –ò–Ω—Ç–µ—Ä–≤—å—é. –¢–µ–∫—Å—Ç—ã": "culture.lit.writer",
            "–ü–æ—ç–∑–∏—è":"culture.lit.poetry",
            "–°–∏–≥–Ω–∞–ª—å–Ω—ã–µ —ç–∫–∑–µ–º–ø–ª—è—Ä—ã": "culture.lit.signal",
            "–¶–∏—Ç–∞—Ç—ã. –ö—Ä—ã–ª–∞—Ç—ã–µ –≤—ã—Ä–∞–∂–µ–Ω–∏—è": "culture.lit.quotation",
            "–≠—Ä–æ—Ç–∏—á–µ—Å–∫–∞—è –ª–∏—Ç–µ—Ä–∞—Ç—É—Ä–∞": "culture.lit.erotic"
        },
        culture_music = {
            "–ê–≤—Ç–æ—Ä—Å–∫–∞—è –ø–µ—Å–Ω—è":"culture.music.bard",
            "–ê–Ω–æ–Ω—Å—ã –º—É–∑—ã–∫–∞–ª—å–Ω—ã—Ö —Å–æ–±—ã—Ç–∏–π": "culture.music.announce",
            "–ì–∏—Ç–∞—Ä–∞":"culture.music.guitar",
            "–ú—É–∑—ã–∫–∞–ª—å–Ω—ã–µ –Ω–æ–≤–æ—Å—Ç–∏":"culture.music.news",
            "–ù–æ–≤–æ—Å—Ç–∏ –≥—Ä—É–ø–ø":"culture.music.group",
            "–†–æ–∫ (—Ç—è–∂–µ–ª—ã–π –∏ –Ω–µ –æ—á–µ–Ω—å)": "culture.music.rock",
            "–•–∏—Ç-–ø–∞—Ä–∞–¥—ã": "culture.music.hit"
        },culture_news,
        culture_rest = {
            "–ê—Å—Ç—Ä–æ–ª–æ–≥–∏—è":"culture.rest.hscope",
            "–ó–Ω–∞–∫–æ–º—Å—Ç–≤–∞": "culture.rest.dating",
            "–ò–Ω—Ç–µ–ª–ª–µ–∫—Ç—É–∞–ª—å–Ω—ã–µ –∏–≥—Ä—ã": "culture.rest.brain",
            "–û –ª—é–±–≤–∏ –∏ —Å–µ–∫—Å–µ":"culture.rest.love",
            "–ü—Ä–∞–∑–¥–Ω–∏–∫":"culture.rest.fest",
            "–°–ø–æ—Ä—Ç–∏–≤–Ω—ã–µ –∏–≥—Ä—ã":"culture.rest.gambling",
            "–¢–µ—Å—Ç—ã":"culture.rest.test",
            "–Æ–º–æ—Ä":"culture.rest.funny"
        },
        culture_psychology = {
            "–¢–µ—Å—Ç—ã":"culture.psychology.test"
        },
        culture_mystery = {
            "–≠–∑–æ—Ç–µ—Ä–∏–∫–∞":"culture.mystery.esoteric"
        },
        woman = {
            "–ñ—É—Ä–Ω–∞–ª—ã": "woman.magazines",
            "–ö—Ä–∞—Å–æ—Ç–∞": "woman.beauty",
            "–û—Ç–Ω–æ—à–µ–Ω–∏—è": "woman.relation"
        },
        woman_magazines,
        woman_beauty = {
            "–û–¥–µ–∂–¥–∞, –æ–±—É–≤—å, –∞–∫—Å–µ—Å—Å—É–∞—Ä—ã":"woman.beauty.goods"
        },
        woman_relation = {
            "–ö–∞—Ä—å–µ—Ä–∞":"woman.relation.job"
        },
        media = {
            "–ò—Ä–∞–∫": "media.iraq",
            "–ù–æ–≤–æ—Å—Ç–∏ –¥–Ω—è": "media.today",
            "–†–ò–ê \"–ù–æ–≤–æ—Å—Ç–∏\"": "media.rian",
            "–†–∞–¥–∏–æ": "media.radio"
        },
        media_iraq,media_rian,media_radio,
        media_today = {
            "–ù–æ–≤–æ—Å—Ç–∏ –æ—Ç Infox.ru":"media.today.infox",
            "–ù–æ–≤–æ—Å—Ç–∏ –æ—Ç KM.RU":"media.today.km"
        },
        socio = {
            "–ì–æ—Å—É–¥–∞—Ä—Å—Ç–≤–æ":"socio.state",
            "–ù–∞—É–∫–∞": "socio.science",
            "–û–±—Ä–∞–∑–æ–≤–∞–Ω–∏–µ": "socio.edu",
            "–ß–µ–ª–æ–≤–µ–∫ –∏ –æ–±—â–µ—Å—Ç–≤–æ": "socio.people"
        },
        socio_state = {
            "–ê—Ä–º–∏—è –∏ —Å–∏–ª–æ–≤—ã–µ —Å—Ç—Ä—É–∫—Ç—É—Ä—ã": "socio.state.army",
            "–ó–∞–∫–æ–Ω–æ–¥–∞—Ç–µ–ª—å—Å—Ç–≤–æ": "socio.state.law",
            "–ü–æ–ª–∏—Ç–∏–∫–∞":"socio.state.politics"
        },
        socio_science = {
            "–ì—É–º–∞–Ω–∏—Ç–∞—Ä–Ω—ã–µ –Ω–∞—É–∫–∏": "socio.science.humanity",
            "–ï—Å—Ç–µ—Å—Ç–≤–µ–Ω–Ω—ã–µ –Ω–∞—É–∫–∏": "socio.science.natural",
            "–ú–æ–¥–µ–ª–∏—Ä–æ–≤–∞–Ω–∏–µ": "socio.science.model",
            "–ù–æ–≤–æ—Å—Ç–∏ –Ω–∞—É–∫–∏": "socio.science.news",
            "–¢–µ—Ö–Ω–∏–∫–∞": "socio.science.tech",
            "–¢–æ—á–Ω—ã–µ –Ω–∞—É–∫–∏": "socio.science.exact"
        },
        socio_edu = {
            "–ò–Ω–æ—Å—Ç—Ä–∞–Ω–Ω—ã–µ —è–∑—ã–∫–∏":"socio.edu.lang",
            "–°—Ç—É–¥–µ–Ω—Ç—É":"socio.edu.student",
            "–®–∫–æ–ª–∞ –±–∏–∑–Ω–µ—Å–∞":"socio.edu.business"
        },
        socio_people = {
            "–ù–∞—Ä–æ–¥—ã –º–∏—Ä–∞": "socio.people.world"
        },
        weather = {
            "–ó–∞ —Ä—É–±–µ–∂–æ–º": "weather.world",
            "–†–æ—Å—Å–∏—è": "weather.russia"
        },
        weather_world,weather_russia,
        sport = {
            "–ë–∞—Å–∫–µ—Ç–±–æ–ª": "sport.basket",
            "–ë–æ–µ–≤—ã–µ –∏—Å–∫—É—Å—Å—Ç–≤–∞": "sport.fighting",
            "–î—Ä—É–≥–∏–µ –≤–∏–¥—ã —Å–ø–æ—Ä—Ç–∞": "sport.others",
            "–ô–æ–≥–∞": "sport.yoga",
            "–ù–æ–≤–æ—Å—Ç–∏. –û–±–∑–æ—Ä—ã. –†–∞–∑–º—ã—à–ª–µ–Ω–∏—è": "sport.news",
            "–¢–µ–Ω–Ω–∏—Å": "sport.tennis",
            "–§–∏–∑–∫—É–ª—å—Ç—É—Ä–∞": "sport.fitness",
            "–§–æ—Ä–º—É–ª–∞-1": "sport.auto",
            "–§—É—Ç–±–æ–ª": "sport.soccer",
            "–•–æ–∫–∫–µ–π": "sport.hockey",
            "–≠–∫—Å—Ç—Ä–∏–º": "sport.extreme"
        },
        sport_basket,sport_fighting,sport_others,sport_yoga,sport_news,sport_tennis,sport_fitness,sport_auto,
        sport_soccer = {
            "–§—É—Ç–±–æ–ª—å–Ω—ã–µ –∫–ª—É–±—ã": "sport.soccer.clubs"
        },
        sport_hockey,sport_extreme,
        country = {
            "–ë–µ–ª–æ—Ä—É—Å—Å–∏—è": "country.by",
            "–î—Ä—É–≥–∏–µ —Å—Ç—Ä–∞–Ω—ã": "country.other",
            "–ï–≤—Ä–æ–ø–µ–π—Å–∫–∏–µ —Å—Ç—Ä–∞–Ω—ã": "country.europe",
            "–ò–∑—Ä–∞–∏–ª—å": "country.il",
            "–ö–∞–∑–∞—Ö—Å—Ç–∞–Ω": "country.kz",
            "–†–æ—Å—Å–∏—è": "country.ru",
            "–°–®–ê": "country.usa",
            "–£–∫—Ä–∞–∏–Ω–∞": "country.ua"
        },
    ...
    country_ru = {
        "–î–∞–ª—å–Ω–∏–π –≤–æ—Å—Ç–æ–∫":"country.ru.fareast",
        "–ú–æ—Å–∫–≤–∞ –∏ –æ–±–ª–∞—Å—Ç—å": "country.ru.msk",
        "–ü–æ–≤–æ–ª–∂—å–µ": "country.ru.volg",
        "–°–∞–Ω–∫—Ç-–ü–µ—Ç–µ—Ä–±—É—Ä–≥": "country.ru.spb",
        "–°–µ–≤–µ—Ä–æ-–ó–∞–ø–∞–¥": "country.ru.nwest",
        "–°–∏–±–∏—Ä—å": "country.ru.sib",
        "–£—Ä–∞–ª": "country.ru.ural",
        "–¶–µ–Ω—Ç—Ä–∞–ª—å–Ω–∞—è —á–∞—Å—Ç—å":"country.ru.center"
    },
    country_ua = {
        "–ó–∞–∫–æ–Ω–æ–¥–∞—Ç–µ–ª—å—Å—Ç–≤–æ":"country.ua.law",
        "–ù–æ–≤–æ—Å—Ç–∏": "country.ua.news",
        "–§–∏–Ω–∞–Ω—Å—ã":"country.ua.fin"
    },
    travel = {
        "–í–∏–∑—ã, –≥—Ä–∞–Ω–∏—Ü—ã": "travel.visa",
        "–ó–∞–∂–∏–≥–∞—Ç–µ–ª—å–Ω—ã–µ –∏–¥–µ–∏":"travel.idea",
        "–ú–∏—Ä–æ–≤—ã–µ –Ω–æ–≤–æ—Å—Ç–∏":"travel.worldnews",
        "–ù–æ–≤–æ—Å—Ç–∏ —Ç—É—Ä–∏–∑–º–∞": "travel.news",
        "–û—Ç–¥—ã—Ö –∑–∞ —Ä—É–±–µ–∂–æ–º":"travel.foreign",
        "–ß—Ç–æ –ø–æ—Å–º–æ—Ç—Ä–µ—Ç—å?": "travel.towatch"
    },
    travel_visa,travel_idea,travel_worldnews,travel_news,travel_foreign,travel_towatch,
    economics = {
        "–ê–Ω–∞–ª–∏—Ç–∏–∫–∞, –ø—Ä–æ–≥–Ω–æ–∑—ã, –∫—É—Ä—Å—ã –≤–∞–ª—é—Ç":"economics.news",
        "–ò–Ω–≤–µ—Å—Ç–∏—Ü–∏–∏": "economics.invest",
        "–ú–∏—Ä–æ–≤–æ–π –∫—Ä–∏–∑–∏—Å": "economics.kris",
        "–û–±—â–µ—Å—Ç–≤–æ": "economics.society",
        "–û—Ç—Ä–∞—Å–ª–∏":"economics.industry",
        "–°–æ–≤–µ—Ç—ã —ç–∫—Å–ø–µ—Ä—Ç–æ–≤": "economics.advice",
        "–§–∏–Ω–∞–Ω—Å—ã": "economics.fin",
        "–≠–∫—Å–ø—Ä–µ—Å—Å-–Ω–æ–≤–æ—Å—Ç–∏":"economics.express"
    },
    economics_news,economics_invest,economics_kris,economics_society,economics_advice,economics_fin,economics_express,
    economics_industry = {
        "–ê—É—Ç—Å–æ—Ä—Å–∏–Ω–≥": "economics.industry.outsourcing",
        "–ë–µ–∑–æ–ø–∞—Å–Ω–æ—Å—Ç—å. –û—Ö—Ä–∞–Ω–Ω–∞—è –¥–µ—è—Ç–µ–ª—å–Ω–æ—Å—Ç—å": "economics.industry.security",
        "–í—ã—Å–æ–∫–∏–µ —Ç–µ—Ö–Ω–æ–ª–æ–≥–∏–∏": "economics.industry.comp",
        "–ò–Ω–¥—É—Å—Ç—Ä–∏—è –∫—Ä–∞—Å–æ—Ç—ã": "economics.industry.beauty",
        "–ü–æ–ª–∏–≥—Ä–∞—Ñ–∏—è": "economics.industry.polygraphy",
        "–ü—Ä–æ–º—ã—à–ª–µ–Ω–Ω–æ—Å—Ç—å": "economics.industry.bll",
        "–ü—Ä–æ—á–µ–µ": "economics.industry.other",
        "–†–µ—Å—Ç–æ—Ä–∞–Ω–Ω—ã–π –±–∏–∑–Ω–µ—Å": "economics.industry.resto",
        "–°–µ–ª—å—Å–∫–æ–µ —Ö–æ–∑—è–π—Å—Ç–≤–æ –∏ –ø–∏—â–µ–≤–∞—è –ø—Ä–æ–º—ã—à–ª–µ–Ω–Ω–æ—Å—Ç—å": "economics.industry.food",
        "–°—Ç—Ä–æ–∏—Ç–µ–ª—å—Å—Ç–≤–æ": "economics.industry.build",
        "–¢–æ—Ä–≥–æ–≤–ª—è": "economics.industry.trade",
        "–¢—Ä–∞–Ω—Å–ø–æ—Ä—Ç –∏ –≥—Ä—É–∑–æ–ø–µ—Ä–µ–≤–æ–∑–∫–∏": "economics.industry.trans",
        "–£—Å–ª—É–≥–∏": "economics.industry.service"
    },
...
function init_upload_file_page_behavior() {
	...
	// –ø–æ–¥—Å–∫–∞–∑–∫–∞ –¥–ª—è –Ω–µ–∞–≤—Ç–æ—Ä–∏–∑–æ–≤–∞–Ω–Ω–æ–π –∑–∞–≥—Ä—É–∑–∫–∏ —Ñ–∞–π–ª–∞.
	$('div.add-file-form input.submit').click(function() {
	    if ($('p.grouplabel a.addmeplease').length > 0) {
		show_alert('–í—Å—Ç—É–ø–∏—Ç–µ –≤ –≥—Ä—É–ø–ø—É, —á—Ç–æ–±—ã –¥–æ–±–∞–≤–ª—è—Ç—å —Ñ–∞–π–ª—ã.');
		return false;
	    }
	});

    $('#namethefile input[name="filename"]').DefaultValue('–ù–∞–∑–æ–≤–∏—Ç–µ —Ñ–∞–π–ª');
}
...
function init_topic_edit_behavior() {
   ...
   /* $('#addfileinput').click(function() {
    ...
    // —É–¥–∞–ª–µ–Ω–∏–µ —Ñ–∞–π–ª–æ–≤ –∏–∑ —Ç–æ–ø–∏–∫–æ–≤
    $('form#topic-create a.delete').click(function() {
        var el = this;
		show_confirm_form('–í—ã –¥–µ–π—Å—Ç–≤–∏—Ç–µ–ª—å–Ω–æ —Ö–æ—Ç–∏—Ç–µ —É–¥–∞–ª–∏—Ç—å —Ñ–∞–π–ª?',
			{
				show: true,
				callback: function() {
    ...
    if (form.length) {
        ...
        $('a.js', topic_type_control).click(function(e) {
            ...
            if (ttype_id === 'ttype_link') {
                ...
                subj_label.text('–î–æ–±–∞–≤–∏—Ç—å —Å—Å—ã–ª–∫—É:');
                ...
                if (ttype_id === 'ttype_poll') {
                    ttype_input.val(4);
                    subj_label.text('–í–æ–ø—Ä–æ—Å –¥–ª—è –≥–æ–ª–æ—Å–æ–≤–∞–Ω–∏—è:');
                    poll_fields.show();
                    topic_files_wrapper.hide();
                } else if (ttype_id === 'ttype_topic') {
                    ttype_input.val(0);
                    subj_label.text('–ù–∞–∑–≤–∞–Ω–∏–µ —Ç–µ–º—ã:');
                    poll_fields.hide();
                    topic_files_wrapper.show();
                }
        ...
        $.post(form.attr('action'),
            ...
            function(data) {
                ...
                var del = $('<a/>').attr({'class': 'delete',
                                          'rel': gid,
                                          'href': list.attr('rel')});
                del.html('<img src="' + static_url + '/img/ico/delete.png" alt="–£–¥–∞–ª–∏—Ç—å" title="–£–¥–∞–ª–∏—Ç—å"/>');
                    ...
                    function(data) {
                        ...
                        $.each(data, function(i, item) {
                            if (i < 10) {
                                ...
                                var b = $('<p style="margin-top: 1em;"><strong>–ü–µ—Ä–≤—ã–µ 10 –Ω–∞–π–¥–µ–Ω–Ω—ã—Ö —Ä–∞—Å—Å—ã–ª–æ–∫. –ï—Å–ª–∏ —Å—Ä–µ–¥–∏ –Ω–∏—Ö –Ω–µ—Ç –∏—Å–∫–æ–º–æ–π ‚Äî —É—Ç–æ—á–Ω–∏—Ç–µ —Å–ª–æ–≤–æ –ø–æ–∏—Å–∫–∞.</strong></p>');
                                b.appendTo(subs_list);
                            }
                        });
                        if (empty == 0) {
                            var b = $('<p style="margin-top: 1em;"><strong>–ù–∏—á–µ–≥–æ –Ω–µ –Ω–∞–π–¥–µ–Ω–æ.</strong></p>');
                            b.appendTo(subs_list);
                    }
                });
            }
...
function init_group_edit_antispam_behavior() {
    $("#id_antispam_filter").DefaultValue("–æ–¥–Ω–∞ —Å—Ç—Ä–æ–∫–∞ - –æ–¥–Ω–æ –∞–Ω—Ç–∏—Å–ø–∞–º-–ø—Ä–∞–≤–∏–ª–æ");
...
function init_group_edit_forum_behavior() {
	...
	$('#forum-topic-list a.delete').click(function() {
		...
		show_confirm_form('–í—ã –¥–µ–π—Å—Ç–≤–∏—Ç–µ–ª—å–Ω–æ —Ö–æ—Ç–∏—Ç–µ —É–¥–∞–ª–∏—Ç—å –≤–∞–∂–Ω—É—é —Ç–µ–º—É?',
			{
				show: true,
				callback: function() {
                    p.remove();
    ...
    $('.f-invite').submit(function(event) {
        $.ajax({
            ...
            success: function(data){
                if(data==1) {$('#sendresult').text('–ü—Ä–∏–≥–ª–∞—à–µ–Ω–∏–µ –æ—Ç–ø—Ä–∞–≤–ª–µ–Ω–æ.').show();
                } else {
                    $('#sendresult').text('–ü—Ä–∏–≥–ª–∞—à–µ–Ω–∏–µ –Ω–µ –æ—Ç–ø—Ä–∞–≤–ª–µ–Ω–æ. –ü–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å —Å —Ç–∞–∫–∏–º –∞–¥—Ä–µ—Å–æ–º —É–∂–µ —Å—É—â–µ—Å—Ç–≤—É–µ—Ç!').show();
                }
            },
            error: function(data){
    ...
    interest_list.find('a.delete').click(function() {
		...
		show_confirm_form('–í—ã –¥–µ–π—Å—Ç–≤–∏—Ç–µ–ª—å–Ω–æ —Ö–æ—Ç–∏—Ç–µ —É–¥–∞–ª–∏—Ç—å —Ä–∞–∑–¥–µ–ª?',
			{
				show: true,
				callback: function(){
    ...
    $('select', interest_list).change(function() {
		...
		if (opt != "-1" && self_topics_count > 0) {
			show_confirm_form('–í—ã –¥–µ–π—Å—Ç–≤–∏—Ç–µ–ª—å–Ω–æ —Ö–æ—Ç–∏—Ç–µ –ø–µ—Ä–µ–º–µ—Å—Ç–∏—Ç—å –≤—Å–µ —Å–æ–¥–µ—Ä–∂–∏–º–æ–µ –≤ –¥—Ä—É–≥–æ–π —Ä–∞–∑–¥–µ–ª?',
				{
					show: true,
					callback: function() {
...
function init_group_membership_requests_behavior() {
	...
	$('a.cancelmemberrequest')
		...
		.click(function() {
			...
			show_confirm_form('–í—ã –¥–µ–π—Å—Ç–≤–∏—Ç–µ–ª—å–Ω–æ —Ö–æ—Ç–∏—Ç–µ –æ—Ç–º–µ–Ω–∏—Ç—å –∑–∞—è–≤–∫—É?',
				{
					show: true,
    ...
    $('form.joinbeforepost').submit(function() {
        var self = $(this);
        show_confirm_form('<b>–ü–∏—Å–∞—Ç—å –≤ –≥—Ä—É–ø–ø—É –º–æ–≥—É—Ç —Ç–æ–ª—å–∫–æ –µ—ë —É—á–∞—Å—Ç–Ω–∏–∫–∏.</b>',
            {
                show: true,
    ...
    $('button.joinbeforeupload', add_file_form).unbind('click').click(function() {
        ...
        show_confirm_form('<b>–î–æ–±–∞–≤–ª—è—Ç—å —Ñ–∞–π–ª—ã –≤ –≥—Ä—É–ø–ø—É –º–æ–≥—É—Ç —Ç–æ–ª—å–∫–æ –µ—ë —É—á–∞—Å—Ç–Ω–∏–∫–∏.</b>',
            {
                show: true,
                text: '–í—Å—Ç—É–ø–∏—Ç—å –≤ –≥—Ä—É–ø–ø—É',
    ...
    /*$('a.joinbeforeview').click(function(){
        ...
        show_confirm_form('<b>–ú–∞—Ç–µ—Ä–∏–∞–ª—ã –≥—Ä—É–ø–ø—ã –¥–æ—Å—Ç—É–ø–Ω—ã —Ç–æ–ª—å–∫–æ –µ–µ —É—á–∞—Å—Ç–Ω–∏–∫–∞–º.</b>',
            {
                show: true,
                text: '–í—Å—Ç—É–ø–∏—Ç—å –≤ –≥—Ä—É–ø–ø—É',
    ...
    $('a.joinbeforeview').click(function(){
        ...
        var messageText = joingroupAdded ? '–°–ø–∞—Å–∏–±–æ, –≤–∞—à–∞ –∑–∞—è–≤–∫–∞ –±—É–¥–µ—Ç —Ä–∞—Å—Å–º–æ—Ç—Ä–µ–Ω–∞ –∞–¥–º–∏–Ω–∏—Å—Ç—Ä–∞—Ç–æ—Ä–æ–º –≤ –±–ª–∏–∂–∞–π—à–µ–µ –≤—Ä–µ–º—è.' : '–ú–∞—Ç–µ—Ä–∏–∞–ª—ã –≥—Ä—É–ø–ø—ã –¥–æ—Å—Ç—É–ø–Ω—ã —Ç–æ–ª—å–∫–æ –µ–µ —É—á–∞—Å—Ç–Ω–∏–∫–∞–º.';
        var redirectLink = joingroupAdded ? link.replace(/^(\/group\/[^\/]+).*$/,"$1") : link + '&join_accepted=1';
        var buttonText = joingroupAdded ? '–í–µ—Ä–Ω—É—Ç—å—Å—è –Ω–∞–∑–∞–¥' : '–í—Å—Ç—É–ø–∏—Ç—å –≤ –≥—Ä—É–ø–ø—É';
